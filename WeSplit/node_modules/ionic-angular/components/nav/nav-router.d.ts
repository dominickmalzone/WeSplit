import { ViewContainerRef, DynamicComponentLoader } from 'angular2/core';
...
export declare class NavRouter extends RouterOutlet {
    ...
    private _nav;
    private _parent;
    constructor(viewContainerRef: ViewContainerRef, loader: DynamicComponentLoader, parentRouter: Router, nameAttr: string, nav: Nav);
