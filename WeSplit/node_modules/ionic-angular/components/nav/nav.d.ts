import { ElementRef, ViewContainerRef, DynamicComponentLoader, NgZone, Renderer, Type, AfterViewInit } from 'angular2/core';
 ...
 */
export declare class Nav extends NavController implements AfterViewInit {
    private _root;
    private _hasInit;
    constructor(viewCtrl: ViewController, parent: NavController, app: IonicApp, config: Config, keyboard: Keyboard, elementRef: ElementRef, zone: NgZone, renderer: Renderer, loader: DynamicComponentLoader);
    /**
     * @private
     */
