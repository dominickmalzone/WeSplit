...
.css-scrollbars ::-webkit-scrollbar {
  width: 9px; }

.css-scrollbars ::-webkit-scrollbar-thumb:vertical {
  min-height: 10px;
...
.css-scrollbars ::-webkit-scrollbar-thumb:vertical:active {
  min-height: 10px;
  border: 2px solid transparent;
  border-radius: 20px;
...
.ios {
  ...
  .ios .alert-radio-icon {
    ...
    order: 1;
    min-width: 30px; }
  .ios .alert-radio[aria-checked=true] {
    color: #327eff; }
  ...
  .ios .button-small {
    ...
    height: 2.1em;
    font-size: 1.3rem; }
    .ios .button-small.button-icon-only ion-icon {
      font-size: 1.3em; }
  .ios .button-block {
    margin-right: 0;
    margin-left: 0; }
  ...
  .ios [fab-fixed] {
    position: fixed; }
  .ios .button-icon-left ion-icon {
    padding-right: .3em;
    font-size: 1.4em;
    line-height: .67;
    pointer-events: none; }
  .ios .button-icon-right ion-icon {
    padding-left: .4em;
    font-size: 1.4em;
    line-height: .67;
    pointer-events: none; }
  ...
  .ios ion-card {
    ...
    .ios ion-card ion-list {
      ...
      .ios ion-card ion-list .item {
        padding-right: 0; }
      .ios ion-card ion-list ion-label {
        padding: 0; }
    .ios ion-card > .item:last-child,
    .ios ion-card > ion-item-sliding:last-child .item {
      border-bottom: 0; }
  ...
  .ios ion-checkbox[primary] .checkbox-checked {
    border-color: #327eff;
    background-color: #327eff; }
    .ios ion-checkbox[primary] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .ios ion-checkbox[secondary] .checkbox-checked {
    border-color: #32db64;
    background-color: #32db64; }
    .ios ion-checkbox[secondary] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .ios ion-checkbox[danger] .checkbox-checked {
    border-color: #f53d3d;
    background-color: #f53d3d; }
    .ios ion-checkbox[danger] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .ios ion-checkbox[light] .checkbox-checked {
    border-color: #f4f4f4;
    background-color: #f4f4f4; }
    .ios ion-checkbox[light] .checkbox-checked .checkbox-inner {
      border-color: #000; }
  .ios ion-checkbox[dark] .checkbox-checked {
    border-color: #222;
    background-color: #222; }
    .ios ion-checkbox[dark] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .ios ion-chip {
    ...
    .ios ion-chip > ion-avatar {
      ...
      .ios ion-chip > ion-avatar img {
        ...
        max-height: 100%;
        border-radius: 50%; }
      .ios ion-chip > ion-icon + ion-label,
      .ios ion-chip > ion-avatar + ion-label {
        margin-left: 8px; }
    .ios ion-chip ion-avatar {
      min-width: 32px;
      min-height: 32px; }
    .ios ion-chip .button {
      ...
      margin-right: -4px;
      height: inherit; }
    .ios ion-chip ion-icon[name="close-circle"] {
      font-size: 1.2em; }
  .ios ion-chip ion-icon[primary] {
    color: #fff;
    background-color: #327eff; }
  .ios ion-chip ion-icon[secondary] {
    color: #fff;
    background-color: #32db64; }
  .ios ion-chip ion-icon[danger] {
    color: #fff;
    background-color: #f53d3d; }
  .ios ion-chip ion-icon[light] {
    color: #000;
    background-color: #f4f4f4; }
  .ios ion-chip ion-icon[dark] {
    color: #fff;
    background-color: #222; }
  .ios [no-padding],
  ...
  .ios .text-input-clear-icon {
    ...
    background-repeat: no-repeat;
    background-position: center; }
  .ios .input-has-value .text-input-clear-icon {
    display: block; }
  ...
  .ios ion-item-options .button {
    ...
    border-radius: 0;
    box-shadow: none; }
  .ios ion-item-options:not([icon-left]) .button-icon-left {
    font-size: 14px; }
    .ios ion-item-options:not([icon-left]) .button-icon-left .button-inner {
      -webkit-box-orient: vertical;
      -webkit-box-direction: normal;
      -webkit-flex-direction: column;
      -ms-flex-direction: column;
      flex-direction: column; }
    .ios ion-item-options:not([icon-left]) .button-icon-left ion-icon {
      padding-right: 0;
      padding-bottom: .3em;
      padding-left: 0; }
  ...
  .ios .item-button {
    ...
    height: 24px;
    font-size: 1.3rem; }
  .ios .item-button.button-icon-only ion-icon,
  .ios .item-button.button-icon-only {
    padding: 0 1px; }
  .ios ion-avatar {
    min-width: 3.6rem;
    min-height: 3.6rem; }
  ...
  .ios ion-item-group ion-item-sliding:last-child .item-inner {
    border: 0; }
  .ios ion-item-divider {
  ...
  .ios ion-list {
    ...
    .ios ion-list > ion-item-sliding:last-child .item-inner {
      border-bottom: 0; }
  ...
  .ios .item-radio-checked ion-label {
    color: #327eff; }
  .ios ion-radio[primary] .radio-checked {
    color: #327eff; }
    .ios ion-radio[primary] .radio-checked .radio-inner {
      border-color: #327eff; }
  .ios ion-radio[secondary] .radio-checked {
    color: #32db64; }
    .ios ion-radio[secondary] .radio-checked .radio-inner {
      border-color: #32db64; }
  .ios ion-radio[danger] .radio-checked {
    color: #f53d3d; }
    .ios ion-radio[danger] .radio-checked .radio-inner {
      border-color: #f53d3d; }
  .ios ion-radio[light] .radio-checked {
    color: #f4f4f4; }
    .ios ion-radio[light] .radio-checked .radio-inner {
      border-color: #f4f4f4; }
  .ios ion-radio[dark] .radio-checked {
    color: #222; }
    .ios ion-radio[dark] .radio-checked .radio-inner {
      border-color: #222; }
  .ios ion-searchbar {
    position: relative;
    display: -webkit-box;
  ...
  .ios .searchbar-clear-icon {
    ...
    padding: 0;
    min-height: 0; }
  .ios .searchbar-has-value.searchbar-focused .searchbar-clear-icon {
    display: block; }
  .ios ion-searchbar {
    padding: 0 8px;
    min-height: 44px;
  ...
  .ios ion-segment[primary] .segment-button {
    ...
    .ios ion-segment[primary] .segment-button:hover:not(.segment-activated) {
      background-color: rgba(50, 126, 255, 0.1); }
    .ios ion-segment[primary] .segment-button:active:not(.segment-activated) {
      background-color: rgba(50, 126, 255, 0.16); }
    .ios ion-segment[primary] .segment-button.segment-activated {
      color: #fff;
      background-color: #327eff; }
  .ios ion-segment[primary] .segment-button-disabled {
    color: rgba(50, 126, 255, 0.3); }
  ...
  .ios ion-segment[secondary] .segment-button {
    ...
    .ios ion-segment[secondary] .segment-button:active:not(.segment-activated) {
      background-color: rgba(50, 219, 100, 0.16); }
    .ios ion-segment[secondary] .segment-button.segment-activated {
      color: #fff;
      background-color: #32db64; }
  .ios ion-segment[secondary] .segment-button-disabled {
  ...
  .ios ion-segment[danger] .segment-button {
    ...
    .ios ion-segment[danger] .segment-button:active:not(.segment-activated) {
      background-color: rgba(245, 61, 61, 0.16); }
    .ios ion-segment[danger] .segment-button.segment-activated {
      color: #fff;
      background-color: #f53d3d; }
  .ios ion-segment[danger] .segment-button-disabled {
  ...
  .ios ion-segment[light] .segment-button {
    ...
    .ios ion-segment[light] .segment-button:active:not(.segment-activated) {
      background-color: rgba(244, 244, 244, 0.16); }
    .ios ion-segment[light] .segment-button.segment-activated {
      color: #000;
      background-color: #f4f4f4; }
  .ios ion-segment[light] .segment-button-disabled {
  ...
  .ios ion-segment[dark] .segment-button {
    ...
    .ios ion-segment[dark] .segment-button:active:not(.segment-activated) {
      background-color: rgba(34, 34, 34, 0.16); }
    .ios ion-segment[dark] .segment-button.segment-activated {
      color: #fff;
      background-color: #222; }
  .ios ion-segment[dark] .segment-button-disabled {
  ...
  .ios tab-highlight {
    display: none; }
  .ios [tabbarLayout=icon-bottom] .tab-button .tab-button-icon {
    -webkit-box-ordinal-group: 11;
    -webkit-order: 10;
    -ms-flex-order: 10;
    order: 10; }
  .ios [tabbarLayout=icon-left] .tab-button {
    -webkit-box-orient: horizontal;
    -webkit-box-direction: normal;
    -webkit-flex-direction: row;
    -ms-flex-direction: row;
    flex-direction: row; }
    .ios [tabbarLayout=icon-left] .tab-button .tab-button-icon {
      padding-right: 8px;
      text-align: right; }
  .ios [tabbarLayout=icon-right] .tab-button {
    -webkit-box-orient: horizontal;
    -webkit-box-direction: normal;
    -webkit-flex-direction: row;
    -ms-flex-direction: row;
    flex-direction: row; }
    .ios [tabbarLayout=icon-right] .tab-button .tab-button-icon {
      -webkit-box-ordinal-group: 11;
      -webkit-order: 10;
      -ms-flex-order: 10;
      order: 10;
      padding-left: 8px;
      text-align: left; }
  .ios [tabbarLayout=icon-hide] .tab-button-icon {
    display: none; }
  .ios [tabbarLayout=title-hide] .tab-button-text {
    display: none; }
  .ios .tab-badge {
    position: absolute;
    top: 6%;
  ...
  .ios .has-icon .tab-badge {
    right: calc(50% - 30px); }
  .ios [tabbarLayout=icon-bottom] .tab-badge,
  ...
  .ios .tab-button-icon {
    ...
    .ios .tab-button-icon::before {
      vertical-align: top; }
  .ios [tabbarLayout=icon-right] .tab-button .tab-button-text,
  .ios [tabbarLayout=icon-left] .tab-button .tab-button-text {
    font-size: 1.4rem;
    line-height: 1.1; }
  .ios [tabbarLayout=icon-right] .tab-button ion-icon,
  .ios [tabbarLayout=icon-left] .tab-button ion-icon {
    min-width: 24px;
    height: 26px;
    font-size: 24px; }
  .ios [tabbarLayout=icon-hide] .tab-button,
  .ios .tab-button.has-title-only {
    min-height: 41px; }
    .ios [tabbarLayout=icon-hide] .tab-button .tab-button-text,
    .ios .tab-button.has-title-only .tab-button-text {
      margin: 2px 0;
      font-size: 1.4rem;
      line-height: 1.1; }
  .ios [tabbarLayout=title-hide] .tab-button,
  ...
  .ios ion-toggle[primary] .toggle-checked {
    background-color: #327eff; }
  .ios ion-toggle[secondary] .toggle-checked {
    background-color: #32db64; }
  .ios ion-toggle[danger] .toggle-checked {
    background-color: #f53d3d; }
  .ios ion-toggle[light] .toggle-checked {
    background-color: #f4f4f4; }
  .ios ion-toggle[dark] .toggle-checked {
    background-color: #222; }
  .ios ion-toast {
    position: absolute;
    top: 0;
  ...
  .ios.hairlines .toolbar-background {
    border-bottom-width: 0.55px; }
  .ios .toolbar[position=bottom] .toolbar-background {
    border-top-width: 1px;
    border-bottom-width: 0; }
  .ios.hairlines .toolbar[position=bottom] .toolbar-background {
    border-top-width: 0.55px; }
  .ios .toolbar-content {
    -webkit-box-flex: 1;
    -webkit-flex: 1;
  ...
  .ios .bar-button-solid-dark {
    ...
    .ios .bar-button-solid-dark.activated {
      color: #fff;
      background-color: #343434; }
  .ios ion-navbar-section.statusbar-padding {
    height: calc(44px + 20px);
    min-height: calc(44px + 20px); }
  .ios ion-navbar-section.statusbar-padding > .toolbar ion-segment,
  .ios ion-navbar-section.statusbar-padding > .toolbar ion-title,
  .ios ion-navbar-section.statusbar-padding > .toolbar {
    padding-top: 20px;
    height: calc(44px + 20px);
    min-height: calc(44px + 20px); }
  .ios .tab-subpage > .toolbar.statusbar-padding:first-child ion-segment,
  .ios .tab-subpage > .toolbar.statusbar-padding:first-child ion-title,
  .ios .tab-subpage > .toolbar.statusbar-padding:first-child,
  ...
  .ios ion-menu > .toolbar.statusbar-padding:first-child ion-segment,
  .ios ion-menu > .toolbar.statusbar-padding:first-child ion-title,
  .ios ion-menu > .toolbar.statusbar-padding:first-child {
    padding-top: 20px;
    height: calc(44px + 20px);
    min-height: calc(44px + 20px); }
  .ios .tab-subpage > ion-content.statusbar-padding:first-child scroll-content,
  .ios ion-nav > ion-page > ion-content.statusbar-padding:first-child scroll-content,
  .ios ion-menu > ion-content.statusbar-padding:first-child scroll-content {
    padding-top: 20px; }
  .ios .tab-subpage > ion-content.statusbar-padding:first-child[padding] scroll-content,
  .ios .tab-subpage > ion-content.statusbar-padding:first-child[padding-top] scroll-content,
  ...
  .ios ion-menu > ion-content.statusbar-padding:first-child[padding] scroll-content,
  .ios ion-menu > ion-content.statusbar-padding:first-child[padding-top] scroll-content {
...
.md {
  ...
  .md .alert-radio[aria-checked=true] {
    color: #327eff; }
  ...
  .md .button-small {
    ...
    height: 2.1em;
    font-size: 1.3rem; }
    .md .button-small.button-icon-only ion-icon {
      font-size: 1.4em; }
  .md .button-block {
    margin-right: 0;
    margin-left: 0; }
  ...
  .md [fab-fixed] {
    position: fixed; }
  .md .button-icon-left ion-icon {
    padding-right: .3em;
    font-size: 1.4em;
    line-height: .67;
    pointer-events: none; }
  .md .button-icon-right ion-icon {
    padding-left: .4em;
    font-size: 1.4em;
    line-height: .67;
    pointer-events: none; }
  ...
  .md ion-card {
    ...
    .md ion-card ion-list {
      margin-bottom: 0; }
      .md ion-card ion-list ion-label {
        padding: 0; }
      .md ion-card ion-list .item-inner {
        border-bottom: 1px solid #dedede; }
    .md ion-card > .item:last-child,
    .md ion-card > ion-item-sliding:last-child .item {
      border-bottom: 0; }
  ...
  .md ion-checkbox + .item-inner ion-label {
    margin-left: 0; }
  .md ion-checkbox[primary] .checkbox-checked {
    border-color: #327eff;
    background-color: #327eff; }
    .md ion-checkbox[primary] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .md ion-checkbox[secondary] .checkbox-checked {
    border-color: #32db64;
    background-color: #32db64; }
    .md ion-checkbox[secondary] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .md ion-checkbox[danger] .checkbox-checked {
    border-color: #f53d3d;
    background-color: #f53d3d; }
    .md ion-checkbox[danger] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .md ion-checkbox[light] .checkbox-checked {
    border-color: #f4f4f4;
    background-color: #f4f4f4; }
    .md ion-checkbox[light] .checkbox-checked .checkbox-inner {
      border-color: #000; }
  .md ion-checkbox[dark] .checkbox-checked {
    border-color: #222;
    background-color: #222; }
    .md ion-checkbox[dark] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .md ion-chip {
    display: -webkit-inline-box;
    display: -webkit-inline-flex;
    ...
    .md ion-chip > ion-avatar {
      ...
      .md ion-chip > ion-avatar img {
        ...
        max-height: 100%;
        border-radius: 50%; }
      .md ion-chip > ion-icon + ion-label,
      .md ion-chip > ion-avatar + ion-label {
        margin-left: 8px; }
    .md ion-chip ion-avatar {
      min-width: 32px;
      min-height: 32px; }
    .md ion-chip .button {
      ...
      margin-right: -4px;
      height: inherit; }
    .md ion-chip ion-icon[name="close-circle"] {
      font-size: 1.2em; }
  .md ion-chip ion-icon[primary] {
    color: #fff;
    background-color: #327eff; }
  .md ion-chip ion-icon[secondary] {
    color: #fff;
    background-color: #32db64; }
  .md ion-chip ion-icon[danger] {
    color: #fff;
    background-color: #f53d3d; }
  .md ion-chip ion-icon[light] {
    color: #000;
    background-color: #f4f4f4; }
  .md ion-chip ion-icon[dark] {
    color: #fff;
    background-color: #222; }
  .md [no-padding],
  ...
  .md .text-input-clear-icon {
    ...
    background-repeat: no-repeat;
    background-position: center; }
  .md .input-has-value .text-input-clear-icon {
    display: block; }
  ...
  .md ion-item-options .button {
    ...
    border-radius: 0;
    box-shadow: none; }
  .md ion-item-options:not([icon-left]) .button-icon-left {
    font-size: 14px; }
    .md ion-item-options:not([icon-left]) .button-icon-left .button-inner {
      -webkit-box-orient: vertical;
      -webkit-box-direction: normal;
      -webkit-flex-direction: column;
      -ms-flex-direction: column;
      flex-direction: column; }
    .md ion-item-options:not([icon-left]) .button-icon-left ion-icon {
      padding-right: 0;
      padding-bottom: .3em;
      padding-left: 0; }
  ...
  .md .item-button {
    ...
    height: 25px;
    font-size: 1.2rem; }
  .md .item-button.button-icon-only ion-icon,
  .md .item-button.button-icon-only {
    padding: 0 1px; }
  ...
  .md ion-list {
    ...
    .md ion-list > ion-item-sliding:last-child ion-label,
    .md ion-list > ion-item-sliding:last-child .item-inner {
      border-bottom: 0; }
  ...
  .md .item-radio-checked ion-label {
    color: #327eff; }
  .md ion-radio[primary] .radio-checked {
    border-color: #327eff; }
  .md ion-radio[primary] .radio-inner {
    background-color: #327eff; }
  .md ion-radio[secondary] .radio-checked {
    border-color: #32db64; }
  .md ion-radio[secondary] .radio-inner {
    background-color: #32db64; }
  .md ion-radio[danger] .radio-checked {
    border-color: #f53d3d; }
  .md ion-radio[danger] .radio-inner {
    background-color: #f53d3d; }
  .md ion-radio[light] .radio-checked {
    border-color: #f4f4f4; }
  .md ion-radio[light] .radio-inner {
    background-color: #f4f4f4; }
  .md ion-radio[dark] .radio-checked {
    border-color: #222; }
  .md ion-radio[dark] .radio-inner {
    background-color: #222; }
  .md ion-searchbar {
    position: relative;
    display: -webkit-box;
  ...
  .md .searchbar-clear-icon {
    ...
    padding: 0;
    min-height: 0; }
  .md .searchbar-has-value.searchbar-focused .searchbar-clear-icon {
    display: block; }
  .md ion-searchbar {
    padding: 8px;
    background: inherit; }
  ...
  .md .searchbar-clear-icon {
    ...
    .md .searchbar-clear-icon.activated {
      background-color: transparent; }
  .md .searchbar-focused:not(.searchbar-hide-cancel) .searchbar-search-icon {
    display: none; }
  .md .searchbar-focused:not(.searchbar-hide-cancel) .searchbar-md-cancel {
    display: -webkit-inline-box;
    display: -webkit-inline-flex;
    display: -ms-inline-flexbox;
    display: inline-flex; }
  ...
  .md tab-highlight {
    display: none; }
  .md [tabbarLayout=icon-bottom] .tab-button .tab-button-icon {
    -webkit-box-ordinal-group: 11;
    -webkit-order: 10;
    -ms-flex-order: 10;
    order: 10; }
  .md [tabbarLayout=icon-left] .tab-button {
    -webkit-box-orient: horizontal;
    -webkit-box-direction: normal;
    -webkit-flex-direction: row;
    -ms-flex-direction: row;
    flex-direction: row; }
    .md [tabbarLayout=icon-left] .tab-button .tab-button-icon {
      padding-right: 8px;
      text-align: right; }
  .md [tabbarLayout=icon-right] .tab-button {
    -webkit-box-orient: horizontal;
    -webkit-box-direction: normal;
    -webkit-flex-direction: row;
    -ms-flex-direction: row;
    flex-direction: row; }
    .md [tabbarLayout=icon-right] .tab-button .tab-button-icon {
      -webkit-box-ordinal-group: 11;
      -webkit-order: 10;
      -ms-flex-order: 10;
      order: 10;
      padding-left: 8px;
      text-align: left; }
  .md [tabbarLayout=icon-hide] .tab-button-icon {
    display: none; }
  .md [tabbarLayout=title-hide] .tab-button-text {
    display: none; }
  .md .tab-badge {
    position: absolute;
    top: 6%;
  ...
  .md .has-icon .tab-badge {
    right: calc(50% - 30px); }
  .md [tabbarLayout=icon-bottom] .tab-badge,
  ...
  .md .tab-button-icon {
    min-width: 7.4rem;
    font-size: 2.4rem; }
  .md [tabbarLayout=icon-bottom] .tab-button {
    padding-top: 8px;
    padding-bottom: 8px; }
  .md [tabbarLayout=icon-right] .tab-button,
  .md [tabbarLayout=icon-left] .tab-button {
    padding-bottom: 10px; }
    .md [tabbarLayout=icon-right] .tab-button ion-icon,
    .md [tabbarLayout=icon-left] .tab-button ion-icon {
      min-width: 24px; }
  .md [tabbarLayout=icon-hide] .tab-button,
  .md [tabbarLayout=title-hide] .tab-button,
  ...
  .md .item-toggle ion-label {
    margin-left: 0; }
  .md ion-toggle[primary] .toggle-checked {
    background-color: #b2ceff; }
  .md ion-toggle[primary] .toggle-checked .toggle-inner {
    background-color: #327eff; }
  .md ion-toggle[secondary] .toggle-checked {
    background-color: #9eeeb6; }
  .md ion-toggle[secondary] .toggle-checked .toggle-inner {
    background-color: #32db64; }
  .md ion-toggle[danger] .toggle-checked {
    background-color: #fbb6b6; }
  .md ion-toggle[danger] .toggle-checked .toggle-inner {
    background-color: #f53d3d; }
  .md ion-toggle[light] .toggle-checked {
    background-color: white; }
  .md ion-toggle[light] .toggle-checked .toggle-inner {
    background-color: #f4f4f4; }
  .md ion-toggle[dark] .toggle-checked {
    background-color: #626262; }
  .md ion-toggle[dark] .toggle-checked .toggle-inner {
    background-color: #222; }
  .md ion-toast {
    position: absolute;
    top: 0;
  ...
  .md .bar-button-solid-dark {
    ...
    .md .bar-button-solid-dark.activated {
      color: #fff;
      background-color: #343434; }
  .md ion-navbar-section.statusbar-padding {
    height: calc(5.6rem + 20px);
    min-height: calc(5.6rem + 20px); }
  .md ion-navbar-section.statusbar-padding > .toolbar {
    padding-top: 20px;
    height: calc(5.6rem + 20px);
    min-height: calc(5.6rem + 20px); }
  .md .tab-subpage > .toolbar.statusbar-padding:first-child,
  .md ion-nav > ion-page > .toolbar.statusbar-padding:first-child,
  .md ion-menu > .toolbar.statusbar-padding:first-child {
    padding-top: 20px;
    height: calc(5.6rem + 20px);
    min-height: calc(5.6rem + 20px); }
  .md .tab-subpage > ion-content.statusbar-padding:first-child scroll-content,
  .md ion-nav > ion-page > ion-content.statusbar-padding:first-child scroll-content,
  .md ion-menu > ion-content.statusbar-padding:first-child scroll-content {
    padding-top: 20px; }
  .md .tab-subpage > ion-content.statusbar-padding:first-child[padding] scroll-content,
  .md .tab-subpage > ion-content.statusbar-padding:first-child[padding-top] scroll-content,
  ...
  .md ion-menu > ion-content.statusbar-padding:first-child[padding] scroll-content,
  .md ion-menu > ion-content.statusbar-padding:first-child[padding-top] scroll-content {
    padding-top: calc(16px + 20px); }
...
.wp {
  ...
  .wp .alert-radio-inner {
    ...
    border-radius: 50%;
    background: #327eff; }
  .wp .alert-radio[aria-checked=true] {
    color: #000; }
  ...
  .wp .button-small {
    ...
    height: 2.1em;
    font-size: 1.3rem; }
    .wp .button-small.button-icon-only ion-icon {
      font-size: 1.4em; }
  .wp .button-block {
    margin-right: 0;
    margin-left: 0; }
  ...
  .wp [fab-fixed] {
    position: fixed; }
  .wp .button-icon-left ion-icon {
    padding-right: .3em;
    font-size: 1.4em;
    line-height: .67;
    pointer-events: none; }
  .wp .button-icon-right ion-icon {
    padding-left: .4em;
    font-size: 1.4em;
    line-height: .67;
    pointer-events: none; }
  ...
  .wp ion-card {
    ...
    .wp ion-card ion-list {
      margin-bottom: 0; }
      .wp ion-card ion-list ion-label {
        padding: 0; }
      .wp ion-card ion-list .item-inner {
        border-bottom: 1px solid transparent; }
    .wp ion-card > .item:last-child,
    .wp ion-card > ion-item-sliding:last-child .item {
      border-bottom: 0; }
    .wp ion-card .item-inner {
      border: 0; }
  ...
  .wp ion-checkbox + .item-inner ion-label {
    margin-left: 0; }
  .wp ion-checkbox[primary] .checkbox-checked {
    border-color: #327eff;
    background-color: #327eff; }
    .wp ion-checkbox[primary] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .wp ion-checkbox[secondary] .checkbox-checked {
    border-color: #32db64;
    background-color: #32db64; }
    .wp ion-checkbox[secondary] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .wp ion-checkbox[danger] .checkbox-checked {
    border-color: #f53d3d;
    background-color: #f53d3d; }
    .wp ion-checkbox[danger] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .wp ion-checkbox[light] .checkbox-checked {
    border-color: #f4f4f4;
    background-color: #f4f4f4; }
    .wp ion-checkbox[light] .checkbox-checked .checkbox-inner {
      border-color: #000; }
  .wp ion-checkbox[dark] .checkbox-checked {
    border-color: #222;
    background-color: #222; }
    .wp ion-checkbox[dark] .checkbox-checked .checkbox-inner {
      border-color: #fff; }
  .wp ion-chip {
    display: -webkit-inline-box;
    display: -webkit-inline-flex;
    ...
    .wp ion-chip > ion-avatar {
      ...
      .wp ion-chip > ion-avatar img {
        ...
        max-height: 100%;
        border-radius: 50%; }
      .wp ion-chip > ion-icon + ion-label,
      .wp ion-chip > ion-avatar + ion-label {
        margin-left: 8px; }
    .wp ion-chip ion-avatar {
      min-width: 32px;
      min-height: 32px; }
    .wp ion-chip .button {
      ...
      margin-right: -4px;
      height: inherit; }
    .wp ion-chip ion-icon[name="close-circle"] {
      font-size: 1.2em; }
  .wp ion-chip ion-icon[primary] {
    color: #fff;
    background-color: #327eff; }
  .wp ion-chip ion-icon[secondary] {
    color: #fff;
    background-color: #32db64; }
  .wp ion-chip ion-icon[danger] {
    color: #fff;
    background-color: #f53d3d; }
  .wp ion-chip ion-icon[light] {
    color: #000;
    background-color: #f4f4f4; }
  .wp ion-chip ion-icon[dark] {
    color: #fff;
    background-color: #222; }
  .wp [no-padding],
  ...
  .wp .text-input-clear-icon {
    ...
    background-repeat: no-repeat;
    background-position: center; }
  .wp .input-has-value .text-input-clear-icon {
    display: block; }
  ...
  .wp .inset-input {
    margin: 6.5px 16px 6.5px 16px;
    padding: 6.5px 8px 6.5px 8px; }
  .wp .input-has-focus .text-input {
    border-color: #327eff; }
  .wp ion-input.ng-valid.input-has-value .text-input {
    border-color: #32db64; }
  .wp ion-input.ng-invalid.ng-touched .text-input {
    border-color: #f53d3d; }
  ...
  .wp ion-item-options .button {
    ...
    border-radius: 0;
    box-shadow: none; }
  .wp ion-item-options:not([icon-left]) .button-icon-left {
    font-size: 14px; }
    .wp ion-item-options:not([icon-left]) .button-icon-left .button-inner {
      -webkit-box-orient: vertical;
      -webkit-box-direction: normal;
      -webkit-flex-direction: column;
      -ms-flex-direction: column;
      flex-direction: column; }
    .wp ion-item-options:not([icon-left]) .button-icon-left ion-icon {
      padding-right: 0;
      padding-bottom: .3em;
      padding-left: 0; }
  ...
  .wp ion-item-sliding.active-slide ion-item-options {
    ...
    display: -ms-flexbox;
    display: flex; }
  .wp ion-item-sliding.active-slide.active-options ion-item-options {
    visibility: visible; }
  .wp .item {
    position: relative;
    padding-right: 0;
  ...
  .wp .item-button {
    ...
    height: 25px;
    font-size: 1.2rem; }
  .wp .item-button.button-icon-only ion-icon,
  .wp .item-button.button-icon-only {
    padding: 0 1px; }
  ...
  .wp ion-item-divider {
    ...
    color: #222;
    background-color: #fff; }
  .wp ion-item-divider[primary] {
    color: #fff;
    background-color: #327eff; }
  .wp ion-item-divider[secondary] {
    color: #fff;
    background-color: #32db64; }
  .wp ion-item-divider[danger] {
    color: #fff;
    background-color: #f53d3d; }
  .wp ion-item-divider[light] {
    color: #000;
    background-color: #f4f4f4; }
  .wp ion-item-divider[dark] {
    color: #fff;
    background-color: #222; }
  .wp ion-item-sliding {
    background-color: #fff; }
  ...
  .wp .item-label-floating [item-right] {
    margin-top: 13px;
    margin-bottom: 13px; }
  .wp ion-label[primary] {
    color: #327eff; }
  .wp ion-label[secondary] {
    color: #32db64; }
  .wp ion-label[danger] {
    color: #f53d3d; }
  .wp ion-label[light] {
  ...
  .wp ion-list {
    margin: 0 0 16px 0; }
    .wp ion-list .item-inner {
      border-bottom: 1px solid transparent; }
    .wp ion-list > .item:first-child,
    .wp ion-list > ion-item-sliding:first-child .item {
      border-top: 1px solid transparent; }
    .wp ion-list > .item:last-child,
    .wp ion-list > ion-item-sliding:last-child .item {
      border-bottom: 1px solid transparent; }
    .wp ion-list > .item:last-child ion-label,
    .wp ion-list > .item:last-child .item-inner,
    .wp ion-list > ion-item-sliding:last-child ion-label,
    .wp ion-list > ion-item-sliding:last-child .item-inner {
      border-bottom: 0; }
  ...
  .wp .item-radio ion-label {
    margin-left: 0; }
  .wp ion-radio[primary] .radio-checked {
    border-color: #327eff; }
  .wp ion-radio[secondary] .radio-checked {
    border-color: #32db64; }
  .wp ion-radio[danger] .radio-checked {
    border-color: #f53d3d; }
  .wp ion-radio[light] .radio-checked {
    border-color: #f4f4f4; }
  .wp ion-radio[dark] .radio-checked {
    border-color: #222; }
  .wp ion-searchbar {
    position: relative;
    display: -webkit-box;
  ...
  .wp .searchbar-clear-icon {
    ...
    padding: 0;
    min-height: 0; }
  .wp .searchbar-has-value.searchbar-focused .searchbar-clear-icon {
    display: block; }
  .wp ion-searchbar {
    padding: 8px;
    background: transparent; }
  ...
  .wp .searchbar-clear-icon {
    ...
    .wp .searchbar-clear-icon.activated {
      background-color: transparent; }
  .wp .searchbar-focused .searchbar-input-container {
    border-color: #327eff; }
  ...
  .wp .toolbar ion-searchbar {
    padding: 2px; }
  .wp ion-searchbar[primary].searchbar-focused .searchbar-input-container {
    border-color: #327eff; }
  .wp ion-searchbar[secondary].searchbar-focused .searchbar-input-container {
    border-color: #32db64; }
  .wp ion-searchbar[danger].searchbar-focused .searchbar-input-container {
    border-color: #f53d3d; }
  .wp ion-searchbar[light].searchbar-focused .searchbar-input-container {
    border-color: #f4f4f4; }
  .wp ion-searchbar[dark].searchbar-focused .searchbar-input-container {
    border-color: #222; }
  .wp ion-segment {
    display: -webkit-box;
    display: -webkit-flex;
  ...
  .wp .toolbar ion-segment {
    margin: 0 auto; }
  .wp ion-segment[primary] .segment-button {
    color: #327eff; }
    .wp ion-segment[primary] .segment-button.activated, .wp ion-segment[primary] .segment-button.segment-activated {
      border-color: #327eff;
      color: #327eff;
      opacity: 1; }
  .wp ion-segment[secondary] .segment-button {
    color: #32db64; }
    .wp ion-segment[secondary] .segment-button.activated, .wp ion-segment[secondary] .segment-button.segment-activated {
      border-color: #32db64;
      color: #32db64;
      opacity: 1; }
  .wp ion-segment[danger] .segment-button {
    color: #f53d3d; }
    .wp ion-segment[danger] .segment-button.activated, .wp ion-segment[danger] .segment-button.segment-activated {
      border-color: #f53d3d;
      color: #f53d3d;
      opacity: 1; }
  .wp ion-segment[light] .segment-button {
    color: #f4f4f4; }
    .wp ion-segment[light] .segment-button.activated, .wp ion-segment[light] .segment-button.segment-activated {
      border-color: #f4f4f4;
      color: #f4f4f4;
      opacity: 1; }
  .wp ion-segment[dark] .segment-button {
    color: #222; }
    .wp ion-segment[dark] .segment-button.activated, .wp ion-segment[dark] .segment-button.segment-activated {
      border-color: #222;
      color: #222;
      opacity: 1; }
  .wp ion-select {
  ...
  .wp ion-tab {
    ...
    .wp ion-tab.show-tab {
      ...
      display: -ms-flexbox;
      display: flex; }
  .wp ion-tabs > ion-navbar-section {
    -webkit-box-ordinal-group: -29;
    -webkit-order: -30;
    -ms-flex-order: -30;
    order: -30; }
  .wp ion-tabbar-section {
    position: relative;
    -webkit-box-ordinal-group: 21;
    -webkit-order: 20;
    -ms-flex-order: 20;
    order: 20; }
  .wp [tabbarPlacement=top] ion-tabbar-section {
    -webkit-box-ordinal-group: -19;
    -webkit-order: -20;
    -ms-flex-order: -20;
    order: -20; }
  ...
  .wp tab-highlight {
    display: none; }
  .wp [tabbarLayout=icon-bottom] .tab-button .tab-button-icon {
    -webkit-box-ordinal-group: 11;
    -webkit-order: 10;
    -ms-flex-order: 10;
    order: 10; }
  .wp [tabbarLayout=icon-left] .tab-button {
    -webkit-box-orient: horizontal;
    -webkit-box-direction: normal;
    -webkit-flex-direction: row;
    -ms-flex-direction: row;
    flex-direction: row; }
    .wp [tabbarLayout=icon-left] .tab-button .tab-button-icon {
      padding-right: 8px;
      text-align: right; }
  .wp [tabbarLayout=icon-right] .tab-button {
    -webkit-box-orient: horizontal;
    -webkit-box-direction: normal;
    -webkit-flex-direction: row;
    -ms-flex-direction: row;
    flex-direction: row; }
    .wp [tabbarLayout=icon-right] .tab-button .tab-button-icon {
      -webkit-box-ordinal-group: 11;
      -webkit-order: 10;
      -ms-flex-order: 10;
      order: 10;
      padding-left: 8px;
      text-align: left; }
  .wp [tabbarLayout=icon-hide] .tab-button-icon {
    display: none; }
  .wp [tabbarLayout=title-hide] .tab-button-text {
    display: none; }
  .wp .tab-badge {
    position: absolute;
    top: 6%;
  ...
  .wp .has-icon .tab-badge {
    right: calc(50% - 30px); }
  .wp [tabbarLayout=icon-bottom] .tab-badge,
  .wp [tabbarLayout=icon-left] .tab-badge,
  .wp [tabbarLayout=icon-right] .tab-badge {
    right: calc(50% - 50px); }
  .wp tabbar {
    background: #f8f8f8; }
  .wp .tab-button {
  ...
  .wp .tab-button-icon {
    min-width: 2.4rem;
    font-size: 2.4rem; }
  .wp [tabbarLayout=icon-bottom] .tab-button {
    padding-top: 8px;
    padding-bottom: 8px; }
  .wp [tabbarLayout=icon-right] .tab-button,
  .wp [tabbarLayout=icon-left] .tab-button {
    padding-bottom: 10px; }
    .wp [tabbarLayout=icon-right] .tab-button ion-icon,
    .wp [tabbarLayout=icon-left] .tab-button ion-icon {
      min-width: 24px; }
  .wp [tabbarLayout=icon-hide] .tab-button,
  .wp [tabbarLayout=title-hide] .tab-button,
  .wp .tab-button.icon-only,
  .wp .tab-button.has-title-only {
    padding: 6px 10px; }
  .wp [tabbarPlacement=bottom] .tab-button {
    border-top: 2px solid transparent;
    border-bottom-width: 0; }
    .wp [tabbarPlacement=bottom] .tab-button[aria-selected=true] {
      border-top-color: #327eff; }
  .wp ion-tabs[primary] tabbar {
    background-color: #327eff; }
    .wp ion-tabs[primary] tabbar .tab-button {
      color: #fff; }
    .wp ion-tabs[primary] tabbar .tab-button:hover:not(.disable-hover),
    .wp ion-tabs[primary] tabbar .tab-button[aria-selected=true] {
      border-color: #fff;
      color: #fff; }
  .wp ion-tabs[secondary] tabbar {
    background-color: #32db64; }
    .wp ion-tabs[secondary] tabbar .tab-button {
      color: #fff; }
    .wp ion-tabs[secondary] tabbar .tab-button:hover:not(.disable-hover),
    .wp ion-tabs[secondary] tabbar .tab-button[aria-selected=true] {
      border-color: #fff;
      color: #fff; }
  .wp ion-tabs[danger] tabbar {
    background-color: #f53d3d; }
    .wp ion-tabs[danger] tabbar .tab-button {
      color: #fff; }
    .wp ion-tabs[danger] tabbar .tab-button:hover:not(.disable-hover),
    .wp ion-tabs[danger] tabbar .tab-button[aria-selected=true] {
      border-color: #fff;
      color: #fff; }
  .wp ion-tabs[light] tabbar {
    background-color: #f4f4f4; }
    .wp ion-tabs[light] tabbar .tab-button {
      color: #000; }
    .wp ion-tabs[light] tabbar .tab-button:hover:not(.disable-hover),
    .wp ion-tabs[light] tabbar .tab-button[aria-selected=true] {
      border-color: #000;
      color: #000; }
  .wp ion-tabs[dark] tabbar {
    background-color: #222; }
    .wp ion-tabs[dark] tabbar .tab-button {
      color: #fff; }
    .wp ion-tabs[dark] tabbar .tab-button:hover:not(.disable-hover),
    .wp ion-tabs[dark] tabbar .tab-button[aria-selected=true] {
      border-color: #fff;
      color: #fff; }
  .wp ion-toggle {
    position: relative; }
  ...
  .wp .item-toggle ion-label {
    margin-left: 0; }
  .wp ion-toggle[primary] .toggle-checked {
    border-color: #327eff;
    background-color: #327eff; }
  .wp ion-toggle[primary] .toggle-checked .toggle-inner {
    background-color: #fff; }
  .wp ion-toggle[secondary] .toggle-checked {
    border-color: #32db64;
    background-color: #32db64; }
  .wp ion-toggle[secondary] .toggle-checked .toggle-inner {
    background-color: #fff; }
  .wp ion-toggle[danger] .toggle-checked {
    border-color: #f53d3d;
    background-color: #f53d3d; }
  .wp ion-toggle[danger] .toggle-checked .toggle-inner {
    background-color: #fff; }
  .wp ion-toggle[light] .toggle-checked {
    border-color: #f4f4f4;
    background-color: #f4f4f4; }
  .wp ion-toggle[light] .toggle-checked .toggle-inner {
    background-color: #000; }
  .wp ion-toggle[dark] .toggle-checked {
    border-color: #222;
    background-color: #222; }
  .wp ion-toggle[dark] .toggle-checked .toggle-inner {
    background-color: #fff; }
  .wp ion-toast {
    position: absolute;
    top: 0;
  ...
  .wp .toolbar[primary] .toolbar-title {
    color: #fff; }
  .wp .toolbar[primary] .bar-button-default ion-button-effect,
  .wp .toolbar[primary] .bar-button-outline ion-button-effect {
    background-color: #fff; }
  .wp .toolbar[primary] .bar-button-outline {
    border-color: #fff; }
  ...
  .wp .toolbar[secondary] .toolbar-title {
    color: #fff; }
  .wp .toolbar[secondary] .bar-button-default ion-button-effect,
  .wp .toolbar[secondary] .bar-button-outline ion-button-effect {
    background-color: #fff; }
  .wp .toolbar[secondary] .bar-button-outline {
    border-color: #fff; }
  ...
  .wp .toolbar[danger] .toolbar-title {
    color: #fff; }
  .wp .toolbar[danger] .bar-button-default ion-button-effect,
  .wp .toolbar[danger] .bar-button-outline ion-button-effect {
    background-color: #fff; }
  .wp .toolbar[danger] .bar-button-outline {
    border-color: #fff; }
  ...
  .wp .toolbar[light] .toolbar-title {
    color: #000; }
  .wp .toolbar[light] .bar-button-default ion-button-effect,
  .wp .toolbar[light] .bar-button-outline ion-button-effect {
    background-color: #000; }
  .wp .toolbar[light] .bar-button-outline {
    border-color: #000; }
  ...
  .wp .toolbar[dark] .toolbar-title {
    color: #fff; }
  .wp .toolbar[dark] .bar-button-default ion-button-effect,
  .wp .toolbar[dark] .bar-button-outline ion-button-effect {
    background-color: #fff; }
  .wp .toolbar[dark] .bar-button-outline {
    border-color: #fff; }
  ...
  .wp .bar-button-solid-dark {
    ...
    .wp .bar-button-solid-dark.activated {
      color: #fff;
      background-color: #343434; }
  .wp ion-navbar-section.statusbar-padding {
    height: calc(4.6rem + 20px);
    min-height: calc(4.6rem + 20px); }
  .wp ion-navbar-section.statusbar-padding > .toolbar {
    padding-top: 20px;
    height: calc(4.6rem + 20px);
    min-height: calc(4.6rem + 20px); }
  .wp .tab-subpage > .toolbar.statusbar-padding:first-child,
  .wp ion-nav > ion-page > .toolbar.statusbar-padding:first-child,
  .wp ion-menu > .toolbar.statusbar-padding:first-child {
    padding-top: 20px;
    height: calc(4.6rem + 20px);
    min-height: calc(4.6rem + 20px); }
  .wp .tab-subpage > ion-content.statusbar-padding:first-child scroll-content,
  .wp ion-nav > ion-page > ion-content.statusbar-padding:first-child scroll-content,
  .wp ion-menu > ion-content.statusbar-padding:first-child scroll-content {
    padding-top: 20px; }
  .wp .tab-subpage > ion-content.statusbar-padding:first-child[padding] scroll-content,
  .wp .tab-subpage > ion-content.statusbar-padding:first-child[padding-top] scroll-content,
  ...
  .wp ion-menu > ion-content.statusbar-padding:first-child[padding] scroll-content,
  .wp ion-menu > ion-content.statusbar-padding:first-child[padding-top] scroll-content {
    padding-top: calc(16px + 20px); }
