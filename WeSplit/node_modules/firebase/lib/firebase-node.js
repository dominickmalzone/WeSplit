...
c.push(":"),Ba(a,a.Td?a.Td.call(b,f,e):e,c),d=","));c.push("}");break;case "function":break;default:throw Error("Unknown type: "+typeof b);}}var Da={'"':'\\"',"\\":"\\\\","/":"\\/","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\u000b"},Ea=/\uffff/.test("\uffff")?/[\\\"\x00-\x1f\x7f-\uffff]/g:/[\\\"\x00-\x1f\x7f-\xff]/g;
function Ca(a,b){b.push('"',a.replace(Ea,function(a){if(a in Da)return Da[a];var b=a.charCodeAt(0),e="\\u";16>b?e+="000":256>b?e+="00":4096>b&&(e+="0");return Da[a]=e+b.toString(16)}),'"')};function Fa(){return Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^ja()).toString(36)};var w;a:{var Ga=n.navigator;if(Ga){var Ha=Ga.userAgent;if(Ha){w=Ha;break a}}w=""};function Ia(){this.Xa=-1};function Ja(){this.Xa=-1;this.Xa=64;this.P=[];this.le=[];this.dg=[];this.Md=[];this.Md[0]=128;for(var a=1;a<this.Xa;++a)this.Md[a]=0;this.de=this.dc=0;this.reset()}ka(Ja,Ia);Ja.prototype.reset=function(){this.P[0]=1732584193;this.P[1]=4023233417;this.P[2]=2562383102;this.P[3]=271733878;this.P[4]=3285377520;this.de=this.dc=0};
function Ka(a,b,c){c||(c=0);var d=a.dg;if(q(b))for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.P[0];c=a.P[1];for(var g=a.P[2],k=a.P[3],m=a.P[4],l,e=0;80>e;e++)40>e?20>e?(f=k^c&(g^k),l=1518500249):(f=c^g^k,l=1859775393):60>e?(f=c&g|k&(c|g),l=2400959708):(f=c^g^k,l=3395469782),f=(b<<
...
Ja.prototype.update=function(a,b){if(null!=a){p(b)||(b=a.length);for(var c=b-this.Xa,d=0,e=this.le,f=this.dc;d<b;){if(0==f)for(;d<=c;)Ka(this,a,d),d+=this.Xa;if(q(a))for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.Xa){Ka(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.Xa){Ka(this,e);f=0;break}}this.dc=f;this.de+=b}};var La=Array.prototype,Ma=La.indexOf?function(a,b,c){return La.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(q(a))return q(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},Na=La.forEach?function(a,b,c){La.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=q(a)?a.split(""):a,f=0;f<d;f++)f in e&&b.call(c,e[f],f,a)},Oa=La.filter?function(a,b,c){return La.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=[],f=
0,g=q(a)?a.split(""):a,k=0;k<d;k++)if(k in g){var m=g[k];b.call(c,m,k,a)&&(e[f++]=m)}return e},Pa=La.map?function(a,b,c){return La.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),f=q(a)?a.split(""):a,g=0;g<d;g++)g in f&&(e[g]=b.call(c,f[g],g,a));return e},Qa=La.reduce?function(a,b,c,d){for(var e=[],f=1,g=arguments.length;f<g;f++)e.push(arguments[f]);d&&(e[0]=u(b,d));return La.reduce.apply(a,e)}:function(a,b,c,d){var e=c;Na(a,function(c,g){e=b.call(d,e,c,g,a)});return e},Ra=La.every?
function(a,b,c){return La.every.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=q(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&!b.call(c,e[f],f,a))return!1;return!0};function Sa(a,b){var c=Ta(a,b,void 0);return 0>c?null:q(a)?a.charAt(c):a[c]}function Ta(a,b,c){for(var d=a.length,e=q(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&b.call(c,e[f],f,a))return f;return-1}function Ua(a,b){var c=Ma(a,b);0<=c&&La.splice.call(a,c,1)}function Va(a,b){a.sort(b||Wa)}function Wa(a,b){return a>b?1:a<b?-1:0};function Xa(a){n.setTimeout(function(){throw a;},0)}var Ya;
...
d)&&a.data==c)this.port1.onmessage()},this);b.addEventListener("message",a,!1);this.port1={};this.port2={postMessage:function(){b.postMessage(c,d)}}});if("undefined"!==typeof a&&-1==w.indexOf("Trident")&&-1==w.indexOf("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(p(c.next)){c=c.next;var a=c.gb;c.gb=null;a()}};return function(a){d.next={gb:a};d=d.next;b.port2.postMessage(0)}}return"undefined"!==typeof document&&"onreadystatechange"in document.createElement("script")?function(a){var b=
document.createElement("script");b.onreadystatechange=function(){b.onreadystatechange=null;b.parentNode.removeChild(b);b=null;a();a=null};document.documentElement.appendChild(b)}:function(a){n.setTimeout(a,0)}};function $a(a,b){ab||bb();cb||(ab(),cb=!0);db.push(new eb(a,b))}var ab;function bb(){if(n.Promise&&n.Promise.resolve){var a=n.Promise.resolve();ab=function(){a.then(fb)}}else ab=function(){var a=fb;!t(n.setImmediate)||n.Window&&n.Window.prototype&&n.Window.prototype.setImmediate==n.setImmediate?(Ya||(Ya=Za()),Ya(a)):n.setImmediate(a)}}var cb=!1,db=[];[].push(function(){cb=!1;db=[]});
...
function Ec(a,b){for(var c,d=a.xa,e=null;!d.e();){c=a.Oa(b,d.key);if(0===c){if(d.left.e())return e?e.key:null;for(d=d.left;!d.right.e();)d=d.right;return d.key}0>c?d=d.left:0<c&&(e=d,d=d.right)}throw Error("Attempted to find predecessor key for a nonexistent key.  What gives?");}h.e=function(){return this.xa.e()};h.count=function(){return this.xa.count()};h.Tc=function(){return this.xa.Tc()};h.ic=function(){return this.xa.ic()};h.ka=function(a){return this.xa.ka(a)};
h.$b=function(a){return new Fc(this.xa,null,this.Oa,!1,a)};h.ac=function(a,b){return new Fc(this.xa,a,this.Oa,!1,b)};h.cc=function(a,b){return new Fc(this.xa,a,this.Oa,!0,b)};h.tf=function(a){return new Fc(this.xa,null,this.Oa,!0,a)};function Fc(a,b,c,d,e){this.Vd=e||null;this.Fe=d;this.Sa=[];for(e=1;!a.e();)if(e=b?c(a.key,b):1,d&&(e*=-1),0>e)a=this.Fe?a.left:a.right;else if(0===e){this.Sa.push(a);break}else this.Sa.push(a),a=this.Fe?a.right:a.left}
function Gc(a){if(0===a.Sa.length)return null;var b=a.Sa.pop(),c;c=a.Vd?a.Vd(b.key,b.value):{key:b.key,value:b.value};if(a.Fe)for(b=b.left;!b.e();)a.Sa.push(b),b=b.right;else for(b=b.right;!b.e();)a.Sa.push(b),b=b.left;return c}function Hc(a){if(0===a.Sa.length)return null;var b;b=a.Sa;b=b[b.length-1];return a.Vd?a.Vd(b.key,b.value):{key:b.key,value:b.value}}function Ic(a,b,c,d,e){this.key=a;this.value=b;this.color=null!=c?c:!0;this.left=null!=d?d:Dc;this.right=null!=e?e:Dc}h=Ic.prototype;
h.$=function(a,b,c,d,e){return new Ic(null!=a?a:this.key,null!=b?b:this.value,null!=c?c:this.color,null!=d?d:this.left,null!=e?e:this.right)};h.count=function(){return this.left.count()+1+this.right.count()};h.e=function(){return!1};h.ka=function(a){return this.left.ka(a)||a(this.key,this.value)||this.right.ka(a)};function Jc(a){return a.left.e()?a:Jc(a.left)}h.Tc=function(){return Jc(this).key};h.ic=function(){return this.right.e()?this.key:this.right.ic()};
h.Ra=function(a,b,c){var d,e;e=this;d=c(a,e.key);e=0>d?e.$(null,null,null,e.left.Ra(a,b,c),null):0===d?e.$(null,b,null,null,null):e.$(null,null,null,null,e.right.Ra(a,b,c));return Kc(e)};function Lc(a){if(a.left.e())return Dc;a.left.ha()||a.left.left.ha()||(a=Mc(a));a=a.$(null,null,null,Lc(a.left),null);return Kc(a)}
h.remove=function(a,b){var c,d;c=this;if(0>b(a,c.key))c.left.e()||c.left.ha()||c.left.left.ha()||(c=Mc(c)),c=c.$(null,null,null,c.left.remove(a,b),null);else{c.left.ha()&&(c=Nc(c));c.right.e()||c.right.ha()||c.right.left.ha()||(c=Oc(c),c.left.left.ha()&&(c=Nc(c),c=Oc(c)));if(0===b(a,c.key)){if(c.right.e())return Dc;d=Jc(c.right);c=c.$(d.key,d.value,null,null,Lc(c.right))}c=c.$(null,null,null,null,c.right.remove(a,b))}return Kc(c)};h.ha=function(){return this.color};
...
h.ya=function(a,b,c){null!=c&&(a.L()||a.R(Q,function(a,e){b.Fa(a)||Id(c,new H("child_removed",e,a))}),b.L()||b.R(Q,function(b,e){if(a.Fa(b)){var f=a.T(b);f.ea(e)||Id(c,new H("child_changed",e,b,f))}else Id(c,new H("child_added",e,b))}));return b.nb(this.g)};h.ia=function(a,b){return a.e()?G:a.ia(b)};h.Qa=function(){return!1};h.Zb=function(){return this};function Kd(a){this.Be=new Jd(a.g);this.g=a.g;var b;a.oa?(b=Ld(a),b=a.g.Qc(Nd(a),b)):b=a.g.Uc();this.dd=b;a.ra?(b=Od(a),a=a.g.Qc(Pd(a),b)):a=a.g.Rc();this.Hc=a}h=Kd.prototype;h.matches=function(a){return 0>=this.g.compare(this.dd,a)&&0>=this.g.compare(a,this.Hc)};h.H=function(a,b,c,d,e,f){this.matches(new K(b,c))||(c=G);return this.Be.H(a,b,c,d,e,f)};
h.ya=function(a,b,c){b.L()&&(b=G);var d=b.nb(this.g),d=d.ia(G),e=this;b.R(Q,function(a,b){e.matches(new K(a,b))||(d=d.W(a,G))});return this.Be.ya(a,d,c)};h.ia=function(a){return a};h.Qa=function(){return!0};h.Zb=function(){return this.Be};function Qd(a){this.ua=new Kd(a);this.g=a.g;N(a.la,"Only valid if limit has been set");this.ma=a.ma;this.Lb=!Rd(a)}h=Qd.prototype;h.H=function(a,b,c,d,e,f){this.ua.matches(new K(b,c))||(c=G);return a.T(b).ea(c)?a:a.Fb()<this.ma?this.ua.Zb().H(a,b,c,d,e,f):Sd(this,a,b,c,e,f)};
h.ya=function(a,b,c){var d;if(b.L()||b.e())d=G.nb(this.g);else if(2*this.ma<b.Fb()&&b.Kc(this.g)){d=G.nb(this.g);b=this.Lb?b.cc(this.ua.Hc,this.g):b.ac(this.ua.dd,this.g);for(var e=0;0<b.Sa.length&&e<this.ma;){var f=Gc(b),g;if(g=this.Lb?0>=this.g.compare(this.ua.dd,f):0>=this.g.compare(f,this.ua.Hc))d=d.W(f.name,f.U),e++;else break}}else{d=b.nb(this.g);d=d.ia(G);var k,m,l;if(this.Lb){b=d.tf(this.g);k=this.ua.Hc;m=this.ua.dd;var r=Td(this.g);l=function(a,b){return r(b,a)}}else b=d.$b(this.g),k=this.ua.dd,
m=this.ua.Hc,l=Td(this.g);for(var e=0,x=!1;0<b.Sa.length;)f=Gc(b),!x&&0>=l(k,f)&&(x=!0),(g=x&&e<this.ma&&0>=l(f,m))?e++:d=d.W(f.name,G)}return this.ua.Zb().ya(a,d,c)};h.ia=function(a){return a};h.Qa=function(){return!0};h.Zb=function(){return this.ua.Zb()};
function Sd(a,b,c,d,e,f){var g;if(a.Lb){var k=Td(a.g);g=function(a,b){return k(b,a)}}else g=Td(a.g);N(b.Fb()==a.ma,"");var m=new K(c,d),l=a.Lb?Ud(b,a.g):Vd(b,a.g),r=a.ua.matches(m);if(b.Fa(c)){for(var x=b.T(c),l=e.ye(a.g,l,a.Lb);null!=l&&(l.name==c||b.Fa(l.name));)l=e.ye(a.g,l,a.Lb);e=null==l?1:g(l,m);if(r&&!d.e()&&0<=e)return null!=f&&Id(f,new H("child_changed",d,c,x)),b.W(c,d);null!=f&&Id(f,new H("child_removed",x,c));b=b.W(c,G);return null!=l&&a.ua.matches(l)?(null!=f&&Id(f,new H("child_added",
l.U,l.name)),b.W(l.name,l.U)):b}return d.e()?b:r&&0<=g(l,m)?(null!=f&&(Id(f,new H("child_removed",l.U,l.name)),Id(f,new H("child_added",d,c))),b.W(c,d).W(l.name,G)):b};function Wd(a,b){this.ie=a;this.ng=b}function Xd(a){this.X=a}
Xd.prototype.fb=function(a,b,c,d){var e=new Hd,f;if(b.type===zc)b.source.we?c=Yd(this,a,b.path,b.Ia,c,d,e):(N(b.source.qf,"Unknown source."),f=b.source.bf||kc(a.w())&&!b.path.e(),c=Zd(this,a,b.path,b.Ia,c,d,f,e));else if(b.type===$d)b.source.we?c=ae(this,a,b.path,b.children,c,d,e):(N(b.source.qf,"Unknown source."),f=b.source.bf||kc(a.w()),c=be(this,a,b.path,b.children,c,d,f,e));else if(b.type===ce)if(b.Wd)if(b=b.path,null!=c.wc(b))c=a;else{f=new Tb(c,a,d);d=a.Q.j();if(b.e()||".priority"===I(b))jc(a.w())?
b=c.Aa(Wb(a)):(b=a.w().j(),N(b instanceof de,"serverChildren would be complete if leaf node"),b=c.Bc(b)),b=this.X.ya(d,b,e);else{var g=I(b),k=c.Ac(g,a.w());null==k&&Ub(a.w(),g)&&(k=d.T(g));b=null!=k?this.X.H(d,g,k,M(b),f,e):a.Q.j().Fa(g)?this.X.H(d,g,G,M(b),f,e):d;b.e()&&jc(a.w())&&(d=c.Aa(Wb(a)),d.L()&&(b=this.X.ya(b,d,e)))}d=jc(a.w())||null!=c.wc(L);c=ee(a,b,d,this.X.Qa())}else c=fe(this,a,b.path,b.Sb,c,d,e);else if(b.type===Bc)d=b.path,b=a.w(),f=b.j(),g=b.ga||d.e(),c=ge(this,new he(a.Q,new Vb(f,
g,b.Xb)),d,c,Sb,e);else throw hd("Unknown operation type: "+b.type);e=qa(e.hb);d=c;b=d.Q;b.ga&&(f=b.j().L()||b.j().e(),g=ie(a),(0<e.length||!a.Q.ga||f&&!b.j().ea(g)||!b.j().C().ea(g.C()))&&e.push(fc(ie(d))));return new Wd(c,e)};
function ge(a,b,c,d,e,f){var g=b.Q;if(null!=d.wc(c))return b;var k;if(c.e())N(jc(b.w()),"If change path is empty, we must have complete server data"),kc(b.w())?(e=Wb(b),d=d.Bc(e instanceof de?e:G)):d=d.Aa(Wb(b)),f=a.X.ya(b.Q.j(),d,f);else{var m=I(c);if(".priority"==m)N(1==je(c),"Can't have a priority with additional path components"),f=g.j(),k=b.w().j(),d=d.kd(c,f,k),f=null!=d?a.X.ia(f,d):g.j();else{var l=M(c);Ub(g,m)?(k=b.w().j(),d=d.kd(c,g.j(),k),d=null!=d?g.j().T(m).H(l,d):g.j().T(m)):d=d.Ac(m,
b.w());f=null!=d?a.X.H(g.j(),m,d,l,e,f):g.j()}}return ee(b,f,g.ga||c.e(),a.X.Qa())}function Zd(a,b,c,d,e,f,g,k){var m=b.w();g=g?a.X:a.X.Zb();if(c.e())d=g.ya(m.j(),d,null);else if(g.Qa()&&!m.Xb)d=m.j().H(c,d),d=g.ya(m.j(),d,null);else{var l=I(c);if(!lc(m,c)&&1<je(c))return b;var r=M(c);d=m.j().T(l).H(r,d);d=".priority"==l?g.ia(m.j(),d):g.H(m.j(),l,d,r,Sb,null)}m=m.ga||c.e();b=new he(b.Q,new Vb(d,m,g.Qa()));return ge(a,b,c,e,new Tb(e,b,f),k)}
function Yd(a,b,c,d,e,f,g){var k=b.Q;e=new Tb(e,b,f);if(c.e())g=a.X.ya(b.Q.j(),d,g),a=ee(b,g,!0,a.X.Qa());else if(f=I(c),".priority"===f)g=a.X.ia(b.Q.j(),d),a=ee(b,g,k.ga,k.Xb);else{c=M(c);var m=k.j().T(f);if(!c.e()){var l=e.rf(f);d=null!=l?".priority"===ke(c)&&l.S(c.parent()).e()?l:l.H(c,d):G}m.ea(d)?a=b:(g=a.X.H(k.j(),f,d,c,e,g),a=ee(b,g,k.ga,a.X.Qa()))}return a}
function ae(a,b,c,d,e,f,g){var k=b;le(d,function(d,l){var r=c.o(d);Ub(b.Q,I(r))&&(k=Yd(a,k,r,l,e,f,g))});le(d,function(d,l){var r=c.o(d);Ub(b.Q,I(r))||(k=Yd(a,k,r,l,e,f,g))});return k}function me(a,b){le(b,function(b,d){a=a.H(b,d)});return a}
function be(a,b,c,d,e,f,g,k){if(b.w().j().e()&&!jc(b.w()))return b;var m=b;c=c.e()?d:ne(oe,c,d);var l=b.w().j();c.children.ka(function(c,d){if(l.Fa(c)){var J=b.w().j().T(c),J=me(J,d);m=Zd(a,m,new O(c),J,e,f,g,k)}});c.children.ka(function(c,d){var J=!Ub(b.w(),c)&&null==d.value;l.Fa(c)||J||(J=b.w().j().T(c),J=me(J,d),m=Zd(a,m,new O(c),J,e,f,g,k))});return m}
function fe(a,b,c,d,e,f,g){if(null!=e.wc(c))return b;var k=kc(b.w()),m=b.w();if(null!=d.value){if(c.e()&&m.ga||lc(m,c))return Zd(a,b,c,m.j().S(c),e,f,k,g);if(c.e()){var l=oe;m.j().R(pe,function(a,b){l=l.set(new O(a),b)});return be(a,b,c,l,e,f,k,g)}return b}l=oe;le(d,function(a){var b=c.o(a);lc(m,b)&&(l=l.set(a,m.j().S(b)))});return be(a,b,c,l,e,f,k,g)};function qe(){}var re={};function Td(a){return u(a.compare,a)}qe.prototype.Ad=function(a,b){return 0!==this.compare(new K("[MIN_NAME]",a),new K("[MIN_NAME]",b))};qe.prototype.Uc=function(){return se};function te(a){N(!a.e()&&".priority"!==I(a),"Can't create PathIndex with empty path or .priority key");this.fc=a}ka(te,qe);h=te.prototype;h.Jc=function(a){return!a.S(this.fc).e()};h.compare=function(a,b){var c=a.U.S(this.fc),d=b.U.S(this.fc),c=c.Ec(d);return 0===c?wc(a.name,b.name):c};
h.Qc=function(a,b){var c=P(a),c=G.H(this.fc,c);return new K(b,c)};h.Rc=function(){var a=G.H(this.fc,ue);return new K("[MAX_NAME]",a)};h.toString=function(){return this.fc.slice().join("/")};function ve(){}ka(ve,qe);h=ve.prototype;h.compare=function(a,b){var c=a.U.C(),d=b.U.C(),c=c.Ec(d);return 0===c?wc(a.name,b.name):c};h.Jc=function(a){return!a.C().e()};h.Ad=function(a,b){return!a.C().ea(b.C())};h.Uc=function(){return se};h.Rc=function(){return new K("[MAX_NAME]",new Wc("[PRIORITY-POST]",ue))};
...
h.hash=function(){if(null===this.Eb){var a="";this.ca.e()||(a+="priority:"+Pe(this.ca.J())+":");var b=typeof this.B,a=a+(b+":"),a="number"===b?a+yd(this.B):a+this.B;this.Eb=jd(a)}return this.Eb};h.Ea=function(){return this.B};h.Ec=function(a){if(a===G)return 1;if(a instanceof de)return-1;N(a.L(),"Unknown node type");var b=typeof a.B,c=typeof this.B,d=Ma(Oe,b),e=Ma(Oe,c);N(0<=d,"Unknown leaf type: "+b);N(0<=e,"Unknown leaf type: "+c);return d===e?"object"===c?0:this.B<a.B?-1:this.B===a.B?0:1:e-d};
h.nb=function(){return this};h.Kc=function(){return!0};h.ea=function(a){return a===this?!0:a.L()?this.B===a.B&&this.ca.ea(a.ca):!1};h.toString=function(){return F(this.J(!0))};function de(a,b,c){this.m=a;(this.ca=b)&&Ne(this.ca);a.e()&&N(!this.ca||this.ca.e(),"An empty node cannot have a priority");this.yb=c;this.Eb=null}h=de.prototype;h.L=function(){return!1};h.C=function(){return this.ca||G};h.ia=function(a){return this.m.e()?this:new de(this.m,a,this.yb)};h.T=function(a){if(".priority"===a)return this.C();a=this.m.get(a);return null===a?G:a};h.S=function(a){var b=I(a);return null===b?this:this.T(b).S(M(a))};h.Fa=function(a){return null!==this.m.get(a)};
h.W=function(a,b){N(b,"We should always be passing snapshot nodes");if(".priority"===a)return this.ia(b);var c=new K(a,b),d,e;b.e()?(d=this.m.remove(a),c=Le(this.yb,c,this.m)):(d=this.m.Ra(a,b),c=Je(this.yb,c,this.m));e=d.e()?G:this.ca;return new de(d,e,c)};h.H=function(a,b){var c=I(a);if(null===c)return b;N(".priority"!==I(a)||1===je(a),".priority must be the last token in a path");var d=this.T(c).H(M(a),b);return this.W(c,d)};h.e=function(){return this.m.e()};h.Fb=function(){return this.m.count()};
var Qe=/^(0|[1-9]\d*)$/;h=de.prototype;h.J=function(a){if(this.e())return null;var b={},c=0,d=0,e=!0;this.R(Q,function(f,g){b[f]=g.J(a);c++;e&&Qe.test(f)?d=Math.max(d,Number(f)):e=!1});if(!a&&e&&d<2*c){var f=[],g;for(g in b)f[g]=b[g];return f}a&&!this.C().e()&&(b[".priority"]=this.C().J());return b};h.hash=function(){if(null===this.Eb){var a="";this.C().e()||(a+="priority:"+Pe(this.C().J())+":");this.R(Q,function(b,c){var d=c.hash();""!==d&&(a+=":"+b+":"+d)});this.Eb=""===a?"":jd(a)}return this.Eb};
h.sf=function(a,b,c){return(c=Re(this,c))?(a=Ec(c,new K(a,b)))?a.name:null:Ec(this.m,a)};function Ud(a,b){var c;c=(c=Re(a,b))?(c=c.Tc())&&c.name:a.m.Tc();return c?new K(c,a.m.get(c)):null}function Vd(a,b){var c;c=(c=Re(a,b))?(c=c.ic())&&c.name:a.m.ic();return c?new K(c,a.m.get(c)):null}h.R=function(a,b){var c=Re(this,a);return c?c.ka(function(a){return b(a.name,a.U)}):this.m.ka(b)};h.$b=function(a){return this.ac(a.Uc(),a)};
h.ac=function(a,b){var c=Re(this,b);if(c)return c.ac(a,function(a){return a});for(var c=this.m.ac(a.name,uc),d=Hc(c);null!=d&&0>b.compare(d,a);)Gc(c),d=Hc(c);return c};h.tf=function(a){return this.cc(a.Rc(),a)};h.cc=function(a,b){var c=Re(this,b);if(c)return c.cc(a,function(a){return a});for(var c=this.m.cc(a.name,uc),d=Hc(c);null!=d&&0<b.compare(d,a);)Gc(c),d=Hc(c);return c};h.Ec=function(a){return this.e()?a.e()?0:-1:a.L()||a.e()?1:a===ue?-1:0};
h.nb=function(a){if(a===pe||sa(this.yb.gc,a.toString()))return this;var b=this.yb,c=this.m;N(a!==pe,"KeyIndex always exists and isn't meant to be added to the IndexMap.");for(var d=[],e=!1,c=c.$b(uc),f=Gc(c);f;)e=e||a.Jc(f.U),d.push(f),f=Gc(c);d=e?Ke(d,Td(a)):re;e=a.toString();c=wa(b.gc);c[e]=a;a=wa(b.Bd);a[e]=d;return new de(this.m,this.ca,new Ie(a,c))};h.Kc=function(a){return a===pe||sa(this.yb.gc,a.toString())};
h.ea=function(a){if(a===this)return!0;if(a.L())return!1;if(this.C().ea(a.C())&&this.m.count()===a.m.count()){var b=this.$b(Q);a=a.$b(Q);for(var c=Gc(b),d=Gc(a);c&&d;){if(c.name!==d.name||!c.U.ea(d.U))return!1;c=Gc(b);d=Gc(a)}return null===c&&null===d}return!1};function Re(a,b){return b===pe?null:a.yb.get(b.toString())}h.toString=function(){return F(this.J(!0))};function P(a,b){if(null===a)return G;var c=null;"object"===typeof a&&".priority"in a?c=a[".priority"]:"undefined"!==typeof b&&(c=b);N(null===c||"string"===typeof c||"number"===typeof c||"object"===typeof c&&".sv"in c,"Invalid priority type found: "+typeof c);"object"===typeof a&&".value"in a&&null!==a[".value"]&&(a=a[".value"]);if("object"!==typeof a||".sv"in a)return new Wc(a,P(c));if(a instanceof Array){var d=G,e=a;v(e,function(a,b){if(y(e,b)&&"."!==b.substring(0,1)){var c=P(a);if(c.L()||!c.e())d=
d.W(b,c)}});return d.ia(P(c))}var f=[],g=!1,k=a;Db(k,function(a){if("string"!==typeof a||"."!==a.substring(0,1)){var b=P(k[a]);b.e()||(g=g||!b.C().e(),f.push(new K(a,b)))}});if(0==f.length)return G;var m=Ke(f,vc,function(a){return a.name},xc);if(g){var l=Ke(f,Td(Q));return new de(m,P(c),new Ie({".priority":l},{".priority":Q}))}return new de(m,P(c),Me)}var Se=Math.log(2);
function Te(a){this.count=parseInt(Math.log(a+1)/Se,10);this.kf=this.count-1;this.mg=a+1&parseInt(Array(this.count+1).join("1"),2)}function Ue(a){var b=!(a.mg&1<<a.kf);a.kf--;return b}
function Ke(a,b,c,d){function e(b,d){var f=d-b;if(0==f)return null;if(1==f){var l=a[b],r=c?c(l):l;return new Ic(r,l.U,!1,null,null)}var l=parseInt(f/2,10)+b,f=e(b,l),x=e(l+1,d),l=a[l],r=c?c(l):l;return new Ic(r,l.U,!1,f,x)}a.sort(b);var f=function(b){function d(b,g){var k=r-b,x=r;r-=b;var x=e(k+1,x),k=a[k],J=c?c(k):k,x=new Ic(J,k.U,g,null,x);f?f.left=x:l=x;f=x}for(var f=null,l=null,r=a.length,x=0;x<b.count;++x){var J=Ue(b),Md=Math.pow(2,b.count-(x+1));J?d(Md,!1):(d(Md,!1),d(Md,!0))}return l}(new Te(a.length));
return null!==f?new Cc(d||b,f):new Cc(d||b)}function Pe(a){return"number"===typeof a?"number:"+yd(a):"string:"+a}function Ne(a){if(a.L()){var b=a.J();N("string"===typeof b||"number"===typeof b||"object"===typeof b&&y(b,".sv"),"Priority must be a string or number.")}else N(a===ue||a.e(),"priority of unexpected type.");N(a===ue||a.C().e(),"Priority nodes can't have a priority of their own.")}var G=new de(new Cc(xc),null,Me);function Ve(){de.call(this,new Cc(xc),G,Me)}ka(Ve,de);h=Ve.prototype;
h.Ec=function(a){return a===this?0:1};h.ea=function(a){return a===this};h.C=function(){return this};h.T=function(){return G};h.e=function(){return!1};var ue=new Ve,se=new K("[MIN_NAME]",G),ye=new K("[MAX_NAME]",ue);function he(a,b){this.Q=a;this.Yd=b}function ee(a,b,c,d){return new he(new Vb(b,c,d),a.Yd)}function ie(a){return a.Q.ga?a.Q.j():null}he.prototype.w=function(){return this.Yd};function Wb(a){return a.Yd.ga?a.Yd.j():null};function We(a,b){this.Y=a;var c=a.n,d=new Jd(c.g),c=Fe(c)?new Jd(c.g):c.la?new Qd(c):new Kd(c);this.Lf=new Xd(c);var e=b.w(),f=b.Q,g=d.ya(G,e.j(),null),k=c.ya(G,f.j(),null);this.Na=new he(new Vb(k,f.ga,c.Qa()),new Vb(g,e.ga,d.Qa()));this.Za=[];this.ug=new Dd(a)}function Xe(a){return a.Y}h=We.prototype;h.w=function(){return this.Na.w().j()};h.ib=function(a){var b=Wb(this.Na);return b&&(Fe(this.Y.n)||!a.e()&&!b.T(I(a)).e())?b.S(a):null};h.e=function(){return 0===this.Za.length};h.Rb=function(a){this.Za.push(a)};
h.lb=function(a,b){var c=[];if(b){N(null==a,"A cancel should cancel all event registrations.");var d=this.Y.path;Na(this.Za,function(a){(a=a.hf(b,d))&&c.push(a)})}if(a){for(var e=[],f=0;f<this.Za.length;++f){var g=this.Za[f];if(!g.matches(a))e.push(g);else if(a.uf()){e=e.concat(this.Za.slice(f+1));break}}this.Za=e}else this.Za=[];return c};
h.fb=function(a,b,c){a.type===$d&&null!==a.source.Jb&&(N(Wb(this.Na),"We should always have a full cache before handling merges"),N(ie(this.Na),"Missing event cache, even though we have a server cache"));var d=this.Na;a=this.Lf.fb(d,a,b,c);b=this.Lf;c=a.ie;N(c.Q.j().Kc(b.X.g),"Event snap not indexed");N(c.w().j().Kc(b.X.g),"Server snap not indexed");N(jc(a.ie.w())||!jc(d.w()),"Once a server snap is complete, it should never go back");this.Na=a.ie;return Ye(this,a.ng,a.ie.Q.j(),null)};
function Ze(a,b){var c=a.Na.Q,d=[];c.j().L()||c.j().R(Q,function(a,b){d.push(new H("child_added",b,a))});c.ga&&d.push(fc(c.j()));return Ye(a,d,c.j(),b)}function Ye(a,b,c,d){return Ed(a.ug,b,c,d?[d]:a.Za)};function $e(a,b,c){this.type=$d;this.source=a;this.path=b;this.children=c}$e.prototype.Yc=function(a){if(this.path.e())return a=this.children.subtree(new O(a)),a.e()?null:a.value?new yc(this.source,L,a.value):new $e(this.source,L,a);N(I(this.path)===a,"Can't get a merge for a child not on the path of the operation");return new $e(this.source,M(this.path),this.children)};$e.prototype.toString=function(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"};function af(a,b){this.f=nd("p:rest:");this.G=a;this.Ib=b;this.Ca=null;this.ba={}}function bf(a,b){if(p(b))return"tag$"+b;N(Ge(a.n),"should have a tag if it's not a default query.");return a.path.toString()}h=af.prototype;
h.zf=function(a,b,c,d){var e=a.path.toString();this.f("Listen called for "+e+" "+a.wa());var f=bf(a,c),g={};this.ba[f]=g;a=He(a.n);var k=this;cf(this,e+".json",a,function(a,b){var r=b;404===a&&(a=r=null);null===a&&k.Ib(e,r,!1,c);z(k.ba,f)===g&&d(a?401==a?"permission_denied":"rest_error:"+a:"ok",null)})};h.Zf=function(a,b){var c=bf(a,b);delete this.ba[c]};h.O=function(a,b){this.Ca=a;var c=Ad(a),d=c.data,c=c.Dc&&c.Dc.exp;b&&b("ok",{auth:d,expires:c})};h.ge=function(a){this.Ca=null;a("ok",null)};
h.Ne=function(){};h.Ff=function(){};h.Kd=function(){};h.put=function(){};h.Af=function(){};h.Ve=function(){};
function cf(a,b,c,d){c=c||{};c.format="export";a.Ca&&(c.auth=a.Ca);var e=(a.G.mb?"https://":"http://")+a.G.host+b+"?"+Gb(c);a.f("Sending REST request for "+e);var f=new XMLHttpRequest;f.onreadystatechange=function(){if(d&&4===f.readyState){a.f("REST Response for "+e+" received. status:",f.status,"response:",f.responseText);var b=null;if(200<=f.status&&300>f.status){try{b=Pb(f.responseText)}catch(c){R("Failed to parse JSON response for "+e+": "+f.responseText)}d(null,b)}else 401!==f.status&&404!==
f.status&&R("Got unsuccessful REST response for "+e+" Status: "+f.status),d(f.status);d=null}};f.open("GET",e,!0);f.send()};function df(a){N(da(a)&&0<a.length,"Requires a non-empty array");this.eg=a;this.Pc={}}df.prototype.fe=function(a,b){var c;c=this.Pc[a]||[];var d=c.length;if(0<d){for(var e=Array(d),f=0;f<d;f++)e[f]=c[f];c=e}else c=[];for(d=0;d<c.length;d++)c[d].Cc.apply(c[d].Pa,Array.prototype.slice.call(arguments,1))};df.prototype.Gb=function(a,b,c){ef(this,a);this.Pc[a]=this.Pc[a]||[];this.Pc[a].push({Cc:b,Pa:c});(a=this.Ae(a))&&b.apply(c,a)};
df.prototype.kc=function(a,b,c){ef(this,a);a=this.Pc[a]||[];for(var d=0;d<a.length;d++)if(a[d].Cc===b&&(!c||c===a[d].Pa)){a.splice(d,1);break}};function ef(a,b){N(Sa(a.eg,function(a){return a===b}),"Unknown event: "+b)};var ff=function(){var a=0,b=[];return function(c){var d=c===a;a=c;for(var e=Array(8),f=7;0<=f;f--)e[f]="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz".charAt(c%64),c=Math.floor(c/64);N(0===c,"Cannot push at time == 0");c=e.join("");if(d){for(f=11;0<=f&&63===b[f];f--)b[f]=0;b[f]++}else for(f=0;12>f;f++)b[f]=Math.floor(64*Math.random());for(f=0;12>f;f++)c+="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz".charAt(b[f]);N(20===c.length,"nextPushId: Length should be 20.");
return c}}();function gf(){df.call(this,["online"]);this.mc=!0;if("undefined"!==typeof window&&"undefined"!==typeof window.addEventListener){var a=this;window.addEventListener("online",function(){a.mc||(a.mc=!0,a.fe("online",!0))},!1);window.addEventListener("offline",function(){a.mc&&(a.mc=!1,a.fe("online",!1))},!1)}}ka(gf,df);gf.prototype.Ae=function(a){N("online"===a,"Unknown event type: "+a);return[this.mc]};ba(gf);function hf(){df.call(this,["visible"]);var a,b;"undefined"!==typeof document&&"undefined"!==typeof document.addEventListener&&("undefined"!==typeof document.hidden?(b="visibilitychange",a="hidden"):"undefined"!==typeof document.mozHidden?(b="mozvisibilitychange",a="mozHidden"):"undefined"!==typeof document.msHidden?(b="msvisibilitychange",a="msHidden"):"undefined"!==typeof document.webkitHidden&&(b="webkitvisibilitychange",a="webkitHidden"));this.Qb=!0;if(b){var c=this;document.addEventListener(b,
function(){var b=!document[a];b!==c.Qb&&(c.Qb=b,c.fe("visible",b))},!1)}}ka(hf,df);hf.prototype.Ae=function(a){N("visible"===a,"Unknown event type: "+a);return[this.Qb]};ba(hf);function O(a,b){if(1==arguments.length){this.u=a.split("/");for(var c=0,d=0;d<this.u.length;d++)0<this.u[d].length&&(this.u[c]=this.u[d],c++);this.u.length=c;this.aa=0}else this.u=a,this.aa=b}function jf(a,b){var c=I(a);if(null===c)return b;if(c===I(b))return jf(M(a),M(b));throw Error("INTERNAL ERROR: innerPath ("+b+") is not within outerPath ("+a+")");}
function kf(a,b){for(var c=a.slice(),d=b.slice(),e=0;e<c.length&&e<d.length;e++){var f=wc(c[e],d[e]);if(0!==f)return f}return c.length===d.length?0:c.length<d.length?-1:1}function I(a){return a.aa>=a.u.length?null:a.u[a.aa]}function je(a){return a.u.length-a.aa}function M(a){var b=a.aa;b<a.u.length&&b++;return new O(a.u,b)}function ke(a){return a.aa<a.u.length?a.u[a.u.length-1]:null}h=O.prototype;
h.toString=function(){for(var a="",b=this.aa;b<this.u.length;b++)""!==this.u[b]&&(a+="/"+this.u[b]);return a||"/"};h.slice=function(a){return this.u.slice(this.aa+(a||0))};h.parent=function(){if(this.aa>=this.u.length)return null;for(var a=[],b=this.aa;b<this.u.length-1;b++)a.push(this.u[b]);return new O(a,0)};
h.o=function(a){for(var b=[],c=this.aa;c<this.u.length;c++)b.push(this.u[c]);if(a instanceof O)for(c=a.aa;c<a.u.length;c++)b.push(a.u[c]);else for(a=a.split("/"),c=0;c<a.length;c++)0<a[c].length&&b.push(a[c]);return new O(b,0)};h.e=function(){return this.aa>=this.u.length};h.ea=function(a){if(je(this)!==je(a))return!1;for(var b=this.aa,c=a.aa;b<=this.u.length;b++,c++)if(this.u[b]!==a.u[c])return!1;return!0};
h.contains=function(a){var b=this.aa,c=a.aa;if(je(this)>je(a))return!1;for(;b<this.u.length;){if(this.u[b]!==a.u[c])return!1;++b;++c}return!0};var L=new O("");function lf(a,b){this.Ta=a.slice();this.Ja=Math.max(1,this.Ta.length);this.mf=b;for(var c=0;c<this.Ta.length;c++)this.Ja+=Nb(this.Ta[c]);mf(this)}lf.prototype.push=function(a){0<this.Ta.length&&(this.Ja+=1);this.Ta.push(a);this.Ja+=Nb(a);mf(this)};lf.prototype.pop=function(){var a=this.Ta.pop();this.Ja-=Nb(a);0<this.Ta.length&&--this.Ja};
function mf(a){if(768<a.Ja)throw Error(a.mf+"has a key path longer than 768 bytes ("+a.Ja+").");if(32<a.Ta.length)throw Error(a.mf+"path specified exceeds the maximum depth that can be written (32) or object contains a cycle "+nf(a));}function nf(a){return 0==a.Ta.length?"":"in property '"+a.Ta.join(".")+"'"};function of(a,b){this.value=a;this.children=b||pf}var pf=new Cc(function(a,b){return a===b?0:a<b?-1:1});function qf(a){var b=oe;v(a,function(a,d){b=b.set(new O(d),a)});return b}h=of.prototype;h.e=function(){return null===this.value&&this.children.e()};function rf(a,b,c){if(null!=a.value&&c(a.value))return{path:L,value:a.value};if(b.e())return null;var d=I(b);a=a.children.get(d);return null!==a?(b=rf(a,M(b),c),null!=b?{path:(new O(d)).o(b.path),value:b.value}:null):null}
function sf(a,b){return rf(a,b,function(){return!0})}h.subtree=function(a){if(a.e())return this;var b=this.children.get(I(a));return null!==b?b.subtree(M(a)):oe};h.set=function(a,b){if(a.e())return new of(b,this.children);var c=I(a),d=(this.children.get(c)||oe).set(M(a),b),c=this.children.Ra(c,d);return new of(this.value,c)};
h.remove=function(a){if(a.e())return this.children.e()?oe:new of(null,this.children);var b=I(a),c=this.children.get(b);return c?(a=c.remove(M(a)),b=a.e()?this.children.remove(b):this.children.Ra(b,a),null===this.value&&b.e()?oe:new of(this.value,b)):this};h.get=function(a){if(a.e())return this.value;var b=this.children.get(I(a));return b?b.get(M(a)):null};
function ne(a,b,c){if(b.e())return c;var d=I(b);b=ne(a.children.get(d)||oe,M(b),c);d=b.e()?a.children.remove(d):a.children.Ra(d,b);return new of(a.value,d)}function tf(a,b){return uf(a,L,b)}function uf(a,b,c){var d={};a.children.ka(function(a,f){d[a]=uf(f,b.o(a),c)});return c(b,a.value,d)}function vf(a,b,c){return wf(a,b,L,c)}function wf(a,b,c,d){var e=a.value?d(c,a.value):!1;if(e)return e;if(b.e())return null;e=I(b);return(a=a.children.get(e))?wf(a,M(b),c.o(e),d):null}
function xf(a,b,c){yf(a,b,L,c)}function yf(a,b,c,d){if(b.e())return a;a.value&&d(c,a.value);var e=I(b);return(a=a.children.get(e))?yf(a,M(b),c.o(e),d):oe}function le(a,b){zf(a,L,b)}function zf(a,b,c){a.children.ka(function(a,e){zf(e,b.o(a),c)});a.value&&c(b,a.value)}function Af(a,b){a.children.ka(function(a,d){d.value&&b(a,d.value)})}var oe=new of(null);of.prototype.toString=function(){var a={};le(this,function(b,c){a[b.toString()]=c.toString()});return F(a)};function Bf(a,b,c){this.type=ce;this.source=Cf;this.path=a;this.Sb=b;this.Wd=c}Bf.prototype.Yc=function(a){if(this.path.e()){if(null!=this.Sb.value)return N(this.Sb.children.e(),"affectedTree should not have overlapping affected paths."),this;a=this.Sb.subtree(new O(a));return new Bf(L,a,this.Wd)}N(I(this.path)===a,"operationForChild called for unrelated child.");return new Bf(M(this.path),this.Sb,this.Wd)};
Bf.prototype.toString=function(){return"Operation("+this.path+": "+this.source.toString()+" ack write revert="+this.Wd+" affectedTree="+this.Sb+")"};var zc=0,$d=1,ce=2,Bc=3;function Df(a,b,c,d){this.we=a;this.qf=b;this.Jb=c;this.bf=d;N(!d||b,"Tagged queries must be from server.")}var Cf=new Df(!0,!1,null,!1),Ef=new Df(!1,!0,null,!1);Df.prototype.toString=function(){return this.we?"user":this.bf?"server(queryID="+this.Jb+")":"server"};function Ff(a){this.Z=a}var Gf=new Ff(new of(null));function Hf(a,b,c){if(b.e())return new Ff(new of(c));var d=sf(a.Z,b);if(null!=d){var e=d.path,d=d.value;b=jf(e,b);d=d.H(b,c);return new Ff(a.Z.set(e,d))}a=ne(a.Z,b,new of(c));return new Ff(a)}function If(a,b,c){var d=a;Db(c,function(a,c){d=Hf(d,b.o(a),c)});return d}Ff.prototype.Sd=function(a){if(a.e())return Gf;a=ne(this.Z,a,oe);return new Ff(a)};function Jf(a,b){var c=sf(a.Z,b);return null!=c?a.Z.get(c.path).S(jf(c.path,b)):null}
function Kf(a){var b=[],c=a.Z.value;null!=c?c.L()||c.R(Q,function(a,c){b.push(new K(a,c))}):a.Z.children.ka(function(a,c){null!=c.value&&b.push(new K(a,c.value))});return b}function Lf(a,b){if(b.e())return a;var c=Jf(a,b);return null!=c?new Ff(new of(c)):new Ff(a.Z.subtree(b))}Ff.prototype.e=function(){return this.Z.e()};Ff.prototype.apply=function(a){return Mf(L,this.Z,a)};
function Mf(a,b,c){if(null!=b.value)return c.H(a,b.value);var d=null;b.children.ka(function(b,f){".priority"===b?(N(null!==f.value,"Priority writes must always be leaf nodes"),d=f.value):c=Mf(a.o(b),f,c)});c.S(a).e()||null===d||(c=c.H(a.o(".priority"),d));return c};function Nf(){this.V=Gf;this.pa=[];this.Nc=-1}function Of(a,b){for(var c=0;c<a.pa.length;c++){var d=a.pa[c];if(d.jd===b)return d}return null}h=Nf.prototype;
h.Sd=function(a){var b=Ta(this.pa,function(b){return b.jd===a});N(0<=b,"removeWrite called with nonexistent writeId.");var c=this.pa[b];this.pa.splice(b,1);for(var d=c.visible,e=!1,f=this.pa.length-1;d&&0<=f;){var g=this.pa[f];g.visible&&(f>=b&&Pf(g,c.path)?d=!1:c.path.contains(g.path)&&(e=!0));f--}if(d){if(e)this.V=Qf(this.pa,Rf,L),this.Nc=0<this.pa.length?this.pa[this.pa.length-1].jd:-1;else if(c.Ia)this.V=this.V.Sd(c.path);else{var k=this;v(c.children,function(a,b){k.V=k.V.Sd(c.path.o(b))})}return!0}return!1};
h.Aa=function(a,b,c,d){if(c||d){var e=Lf(this.V,a);return!d&&e.e()?b:d||null!=b||null!=Jf(e,L)?(e=Qf(this.pa,function(b){return(b.visible||d)&&(!c||!(0<=Ma(c,b.jd)))&&(b.path.contains(a)||a.contains(b.path))},a),b=b||G,e.apply(b)):null}e=Jf(this.V,a);if(null!=e)return e;e=Lf(this.V,a);return e.e()?b:null!=b||null!=Jf(e,L)?(b=b||G,e.apply(b)):null};
h.Bc=function(a,b){var c=G,d=Jf(this.V,a);if(d)d.L()||d.R(Q,function(a,b){c=c.W(a,b)});else if(b){var e=Lf(this.V,a);b.R(Q,function(a,b){var d=Lf(e,new O(a)).apply(b);c=c.W(a,d)});Na(Kf(e),function(a){c=c.W(a.name,a.U)})}else e=Lf(this.V,a),Na(Kf(e),function(a){c=c.W(a.name,a.U)});return c};h.kd=function(a,b,c,d){N(c||d,"Either existingEventSnap or existingServerSnap must exist");a=a.o(b);if(null!=Jf(this.V,a))return null;a=Lf(this.V,a);return a.e()?d.S(b):a.apply(d.S(b))};
h.Ac=function(a,b,c){a=a.o(b);var d=Jf(this.V,a);return null!=d?d:Ub(c,b)?Lf(this.V,a).apply(c.j().T(b)):null};h.wc=function(a){return Jf(this.V,a)};h.me=function(a,b,c,d,e,f){var g;a=Lf(this.V,a);g=Jf(a,L);if(null==g)if(null!=b)g=a.apply(b);else return[];g=g.nb(f);if(g.e()||g.L())return[];b=[];a=Td(f);e=e?g.cc(c,f):g.ac(c,f);for(f=Gc(e);f&&b.length<d;)0!==a(f,c)&&b.push(f),f=Gc(e);return b};
function Pf(a,b){return a.Ia?a.path.contains(b):!!ta(a.children,function(c,d){return a.path.o(d).contains(b)})}function Rf(a){return a.visible}
function Qf(a,b,c){for(var d=Gf,e=0;e<a.length;++e){var f=a[e];if(b(f)){var g=f.path;if(f.Ia)c.contains(g)?(g=jf(c,g),d=Hf(d,g,f.Ia)):g.contains(c)&&(g=jf(g,c),d=Hf(d,L,f.Ia.S(g)));else if(f.children)if(c.contains(g))g=jf(c,g),d=If(d,g,f.children);else{if(g.contains(c))if(g=jf(g,c),g.e())d=If(d,L,f.children);else if(f=z(f.children,I(g)))f=f.S(M(g)),d=Hf(d,L,f)}else throw hd("WriteRecord should have .snap or .children");}}return d}function Sf(a,b){this.Ob=a;this.Z=b}h=Sf.prototype;
h.Aa=function(a,b,c){return this.Z.Aa(this.Ob,a,b,c)};h.Bc=function(a){return this.Z.Bc(this.Ob,a)};h.kd=function(a,b,c){return this.Z.kd(this.Ob,a,b,c)};h.wc=function(a){return this.Z.wc(this.Ob.o(a))};h.me=function(a,b,c,d,e){return this.Z.me(this.Ob,a,b,c,d,e)};h.Ac=function(a,b){return this.Z.Ac(this.Ob,a,b)};h.o=function(a){return new Sf(this.Ob.o(a),this.Z)};function Tf(){this.children={};this.md=0;this.value=null}function Uf(a,b,c){this.Hd=a?a:"";this.Ga=b?b:null;this.A=c?c:new Tf}function Vf(a,b){for(var c=b instanceof O?b:new O(b),d=a,e;null!==(e=I(c));)d=new Uf(e,d,z(d.A.children,e)||new Tf),c=M(c);return d}h=Uf.prototype;h.Ea=function(){return this.A.value};function Wf(a,b){N("undefined"!==typeof b,"Cannot set value to undefined");a.A.value=b;Xf(a)}h.clear=function(){this.A.value=null;this.A.children={};this.A.md=0;Xf(this)};
h.wd=function(){return 0<this.A.md};h.e=function(){return null===this.Ea()&&!this.wd()};h.R=function(a){var b=this;v(this.A.children,function(c,d){a(new Uf(d,b,c))})};function Yf(a,b,c,d){c&&!d&&b(a);a.R(function(a){Yf(a,b,!0,d)});c&&d&&b(a)}function Zf(a,b){for(var c=a.parent();null!==c&&!b(c);)c=c.parent()}h.path=function(){return new O(null===this.Ga?this.Hd:this.Ga.path()+"/"+this.Hd)};h.name=function(){return this.Hd};h.parent=function(){return this.Ga};
function Xf(a){if(null!==a.Ga){var b=a.Ga,c=a.Hd,d=a.e(),e=y(b.A.children,c);d&&e?(delete b.A.children[c],b.A.md--,Xf(b)):d||e||(b.A.children[c]=a.A,b.A.md++,Xf(b))}};var $f=/[\[\].#$\/\u0000-\u001F\u007F]/,ag=/[\[\].#$\u0000-\u001F\u007F]/,bg=/^[a-zA-Z][a-zA-Z._\-+]+$/;function cg(a){return q(a)&&0!==a.length&&!$f.test(a)}function dg(a){return null===a||q(a)||fa(a)&&!rd(a)||ga(a)&&y(a,".sv")}function eg(a,b,c,d){d&&!p(b)||fg(D(a,1,d),b,c)}
function fg(a,b,c){c instanceof O&&(c=new lf(c,a));if(!p(b))throw Error(a+"contains undefined "+nf(c));if(t(b))throw Error(a+"contains a function "+nf(c)+" with contents: "+b.toString());if(rd(b))throw Error(a+"contains "+b.toString()+" "+nf(c));if(q(b)&&b.length>10485760/3&&10485760<Nb(b))throw Error(a+"contains a string greater than 10485760 utf8 bytes "+nf(c)+" ('"+b.substring(0,50)+"...')");if(ga(b)){var d=!1,e=!1;Db(b,function(b,g){if(".value"===b)d=!0;else if(".priority"!==b&&".sv"!==b&&(e=
!0,!cg(b)))throw Error(a+" contains an invalid key ("+b+") "+nf(c)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');c.push(b);fg(a,g,c);c.pop()});if(d&&e)throw Error(a+' contains ".value" child '+nf(c)+" in addition to actual children.");}}
function gg(a,b){var c,d;for(c=0;c<b.length;c++){d=b[c];for(var e=d.slice(),f=0;f<e.length;f++)if((".priority"!==e[f]||f!==e.length-1)&&!cg(e[f]))throw Error(a+"contains an invalid key ("+e[f]+") in path "+d.toString()+'. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');}b.sort(kf);e=null;for(c=0;c<b.length;c++){d=b[c];if(null!==e&&e.contains(d))throw Error(a+"contains a path "+e.toString()+" that is ancestor of another path "+d.toString());e=d}}
function hg(a,b,c){var d=D(a,1,!1);if(!ga(b)||da(b))throw Error(d+" must be an object containing the children to replace.");var e=[];Db(b,function(a,b){var k=new O(a);fg(d,b,c.o(k));if(".priority"===ke(k)&&!dg(b))throw Error(d+"contains an invalid value for '"+k.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");e.push(k)});gg(d,e)}
function ig(a,b,c){if(rd(c))throw Error(D(a,b,!1)+"is "+c.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!dg(c))throw Error(D(a,b,!1)+"must be a valid Firebase priority (a string, finite number, server value, or null).");}
function jg(a,b,c){if(!c||p(b))switch(b){case "value":case "child_added":case "child_removed":case "child_changed":case "child_moved":break;default:throw Error(D(a,1,c)+'must be a valid event type: "value", "child_added", "child_removed", "child_changed", or "child_moved".');}}function kg(a,b){if(p(b)&&!cg(b))throw Error(D(a,2,!0)+'was an invalid key: "'+b+'".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").');}
function lg(a,b){if(!q(b)||0===b.length||ag.test(b))throw Error(D(a,1,!1)+'was an invalid path: "'+b+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"');}function mg(a,b){if(".info"===I(b))throw Error(a+" failed: Can't modify data under /.info/");}function ng(a,b){if(!q(b))throw Error(D(a,1,!1)+"must be a valid credential (a string).");}function og(a,b,c){if(!q(c))throw Error(D(a,b,!1)+"must be a valid string.");}
function pg(a,b){og(a,1,b);if(!bg.test(b))throw Error(D(a,1,!1)+"'"+b+"' is not a valid authentication provider.");}function qg(a,b,c,d){if(!d||p(c))if(!ga(c)||null===c)throw Error(D(a,b,d)+"must be a valid object.");}function rg(a,b,c){if(!ga(b)||!y(b,c))throw Error(D(a,1,!1)+'must contain the key "'+c+'"');if(!q(z(b,c)))throw Error(D(a,1,!1)+'must contain the key "'+c+'" with type "string"');};function sg(){this.set={}}h=sg.prototype;h.add=function(a,b){this.set[a]=null!==b?b:!0};h.contains=function(a){return y(this.set,a)};h.get=function(a){return this.contains(a)?this.set[a]:void 0};h.remove=function(a){delete this.set[a]};h.clear=function(){this.set={}};h.e=function(){return va(this.set)};h.count=function(){return oa(this.set)};function tg(a,b){v(a.set,function(a,d){b(d,a)})}h.keys=function(){var a=[];v(this.set,function(b,c){a.push(c)});return a};function Tc(){this.m=this.B=null}Tc.prototype.find=function(a){if(null!=this.B)return this.B.S(a);if(a.e()||null==this.m)return null;var b=I(a);a=M(a);return this.m.contains(b)?this.m.get(b).find(a):null};Tc.prototype.qc=function(a,b){if(a.e())this.B=b,this.m=null;else if(null!==this.B)this.B=this.B.H(a,b);else{null==this.m&&(this.m=new sg);var c=I(a);this.m.contains(c)||this.m.add(c,new Tc);c=this.m.get(c);a=M(a);c.qc(a,b)}};
...
Pg.prototype.open=function(a,b,c){var d=qd(a),e="http"===d.scheme?require("http"):require("https");a=this.options.method;var f,g={Accept:"application/json;text/plain"};ya(g,this.options.headers);d={host:d.host.split(":")[0],port:d.port,path:d.oc,method:this.options.method.toUpperCase()};if("GET"===a)d.path+=(/\?/.test(d.path)?"":"?")+Gb(b),f=null;else{var k=this.options.headers.content_type;"application/json"===k&&(f=F(b));"application/x-www-form-urlencoded"===k&&(f=Gb(b));g["Content-Length"]=Buffer.byteLength(f,
"utf8")}d.headers=g;b=e.request(d,function(a){var b="";a.setEncoding("utf8");a.on("data",function(a){b+=a});a.on("end",function(){try{b=Pb(b+"")}catch(a){}c&&(c(null,b),c=null)})});"GET"!==a&&b.write(f);b.on("error",function(a){a&&a.code&&("ENOTFOUND"===a.code||"ENETDOWN"===a.code)?c(T("NETWORK_ERROR")):c(T("SERVER_ERROR"));c=null});b.end()};Pg.isAvailable=function(){return!0};Pg.prototype.Ub=function(){return"json"};function Qg(a){a.method||(a.method="GET");a.headers||(a.headers={});a.headers.content_type||(a.headers.content_type="application/json");a.headers.content_type=a.headers.content_type.toLowerCase();this.options=a}
Qg.prototype.open=function(a,b,c){function d(){c&&(c(T("REQUEST_INTERRUPTED")),c=null)}var e=new XMLHttpRequest,f=this.options.method.toUpperCase(),g;Dg(window,"beforeunload",d);e.onreadystatechange=function(){if(c&&4===e.readyState){var a;if(200<=e.status&&300>e.status){try{a=Pb(e.responseText)}catch(b){}c(null,a)}else 500<=e.status&&600>e.status?c(T("SERVER_ERROR")):c(T("NETWORK_ERROR"));c=null;Eg(window,"beforeunload",d)}};if("GET"===f)a+=(/\?/.test(a)?"":"?")+Gb(b),g=null;else{var k=this.options.headers.content_type;
"application/json"===k&&(g=F(b));"application/x-www-form-urlencoded"===k&&(g=Gb(b))}e.open(f,a,!0);a={"X-Requested-With":"XMLHttpRequest",Accept:"application/json;text/plain"};ya(a,this.options.headers);for(var m in a)e.setRequestHeader(m,a[m]);e.send(g)};Qg.isAvailable=function(){return!1};Qg.prototype.Ub=function(){return"json"};function Rg(a){this.sc=Fa()+Fa()+Fa();this.Jf=a}
Rg.prototype.open=function(a,b,c){function d(){c&&(c(T("USER_CANCELLED")),c=null)}var e=this,f=qd(vg),g;b.requestId=this.sc;b.redirectTo=f.scheme+"://"+f.host+"/blank/page.html";a+=/\?/.test(a)?"":"?";a+=Gb(b);(g=window.open(a,"_blank","location=no"))&&t(g.addEventListener)?(g.addEventListener("loadstart",function(a){var b;if(b=a&&a.url)a:{try{var l=document.createElement("a");l.href=a.url;b=l.host===f.host&&"/blank/page.html"===l.pathname;break a}catch(r){}b=!1}b&&(a=Gg(a.url),g.removeEventListener("exit",
d),g.close(),a=new wg(null,null,{requestId:e.sc,requestKey:a}),e.Jf.requestWithCredential("/auth/session",a,c),c=null)}),g.addEventListener("exit",d)):c(T("TRANSPORT_UNAVAILABLE"))};Rg.isAvailable=function(){return!1};Rg.prototype.Ub=function(){return"redirect"};function Sg(a){a.callback_parameter||(a.callback_parameter="callback");this.options=a;window.__firebase_auth_jsonp=window.__firebase_auth_jsonp||{}}
...
a.Oe&&(a.Oe(c),a.Oe=null),a.na=null,a.close()):"r"===d?(a.f("Reset packet received.  New host: "+c),cd(a.G,c),1===a.N?a.close():(Mh(a),Gh(a))):"e"===d?od("Server Error: "+c):"o"===d?(a.f("got pong on primary."),Nh(a),Oh(a)):od("Unknown control packet command: "+d)}else"d"==d&&a.Jd(c)}else if(b===a.F)if(d=ud("t",c),c=ud("d",c),"c"==d)"t"in c&&(c=c.t,"a"===c?Ph(a):"r"===c?(a.f("Got a reset on secondary, closing it"),a.F.close(),a.gd!==a.F&&a.bd!==a.F||a.close()):"o"===c&&(a.f("got pong on secondary."),
...
c=new A;hi(this.ad,this.ta,a,B(c,b));return c.D};V.prototype.update=V.prototype.update;function W(a,b,c){this.A=a;this.Y=b;this.g=c}W.prototype.J=function(){C("Firebase.DataSnapshot.val",0,0,arguments.length);return this.A.J()};W.prototype.val=W.prototype.J;W.prototype.nf=function(){C("Firebase.DataSnapshot.exportVal",0,0,arguments.length);return this.A.J(!0)};W.prototype.exportVal=W.prototype.nf;W.prototype.xg=function(){C("Firebase.DataSnapshot.exists",0,0,arguments.length);return!this.A.e()};W.prototype.exists=W.prototype.xg;
W.prototype.o=function(a){C("Firebase.DataSnapshot.child",0,1,arguments.length);fa(a)&&(a=String(a));lg("Firebase.DataSnapshot.child",a);var b=new O(a),c=this.Y.o(b);return new W(this.A.S(b),c,Q)};W.prototype.child=W.prototype.o;W.prototype.Fa=function(a){C("Firebase.DataSnapshot.hasChild",1,1,arguments.length);lg("Firebase.DataSnapshot.hasChild",a);var b=new O(a);return!this.A.S(b).e()};W.prototype.hasChild=W.prototype.Fa;
W.prototype.C=function(){C("Firebase.DataSnapshot.getPriority",0,0,arguments.length);return this.A.C().J()};W.prototype.getPriority=W.prototype.C;W.prototype.forEach=function(a){C("Firebase.DataSnapshot.forEach",1,1,arguments.length);E("Firebase.DataSnapshot.forEach",1,a,!1);if(this.A.L())return!1;var b=this;return!!this.A.R(this.g,function(c,d){return a(new W(d,b.Y.o(c),Q))})};W.prototype.forEach=W.prototype.forEach;
W.prototype.wd=function(){C("Firebase.DataSnapshot.hasChildren",0,0,arguments.length);return this.A.L()?!1:!this.A.e()};W.prototype.hasChildren=W.prototype.wd;W.prototype.name=function(){R("Firebase.DataSnapshot.name() being deprecated. Please use Firebase.DataSnapshot.key() instead.");C("Firebase.DataSnapshot.name",0,0,arguments.length);return this.key()};W.prototype.name=W.prototype.name;W.prototype.key=function(){C("Firebase.DataSnapshot.key",0,0,arguments.length);return this.Y.key()};
W.prototype.key=W.prototype.key;W.prototype.Fb=function(){C("Firebase.DataSnapshot.numChildren",0,0,arguments.length);return this.A.Fb()};W.prototype.numChildren=W.prototype.Fb;W.prototype.Kb=function(){C("Firebase.DataSnapshot.ref",0,0,arguments.length);return this.Y};W.prototype.ref=W.prototype.Kb;function ii(a,b,c){this.Tb=a;this.rb=b;this.tb=c||null}h=ii.prototype;h.Of=function(a){return"value"===a};h.createEvent=function(a,b){var c=b.n.g;return new hc("value",this,new W(a.Ma,b.Kb(),c))};h.Yb=function(a){var b=this.tb;if("cancel"===a.ze()){N(this.rb,"Raising a cancel event on a listener with no cancel callback");var c=this.rb;return function(){c.call(b,a.error)}}var d=this.Tb;return function(){d.call(b,a.Zd)}};h.hf=function(a,b){return this.rb?new ic(this,a,b):null};
...
typeof c)throw Error("Query: When ordering by key, the argument passed to startAt(), endAt(),or equalTo() must be a string.");}}else if(a.g===Q){if(null!=b&&!dg(b)||null!=c&&!dg(c))throw Error("Query: When ordering by priority, the first argument passed to startAt(), endAt(), or equalTo() must be a valid priority value (null, a number, or a string).");}else if(N(a.g instanceof te||a.g===ze,"unknown index type."),null!=b&&"object"===typeof b||null!=c&&"object"===typeof c)throw Error("Query: First argument passed to startAt(), endAt(), or equalTo() cannot be an object.");
...
X.prototype.o=function(a){C("Firebase.child",1,1,arguments.length);if(fa(a))a=String(a);else if(!(a instanceof O))if(null===I(this.path)){var b=a;b&&(b=b.replace(/^\/*\.info(\/|$)/,"/"));lg("Firebase.child",b)}else lg("Firebase.child",a);return new X(this.k,this.path.o(a))};X.prototype.child=X.prototype.o;X.prototype.parent=function(){C("Firebase.parent",0,0,arguments.length);var a=this.path.parent();return null===a?null:new X(this.k,a)};X.prototype.parent=X.prototype.parent;
X.prototype.root=function(){C("Firebase.ref",0,0,arguments.length);for(var a=this;null!==a.parent();)a=a.parent();return a};X.prototype.root=X.prototype.root;X.prototype.set=function(a,b){C("Firebase.set",1,2,arguments.length);mg("Firebase.set",this.path);eg("Firebase.set",a,this.path,!1);E("Firebase.set",2,b,!0);var c=new A;this.k.Mb(this.path,a,null,B(c,b));return c.D};X.prototype.set=X.prototype.set;
X.prototype.update=function(a,b){C("Firebase.update",1,2,arguments.length);mg("Firebase.update",this.path);if(da(a)){for(var c={},d=0;d<a.length;++d)c[""+d]=a[d];a=c;R("Passing an Array to Firebase.update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")}hg("Firebase.update",a,this.path);E("Firebase.update",2,b,!0);c=new A;this.k.update(this.path,a,B(c,b));return c.D};
...
X.prototype.jg=function(a,b,c,d){C("Firebase.authWithOAuthToken",2,4,arguments.length);3===arguments.length&&Fb(c)&&(d=c,c=void 0);pg("Firebase.authWithOAuthToken",a);E("Firebase.authWithOAuthToken",3,c,!0);qg("Firebase.authWithOAuthToken",4,d,!0);var e=new A;q(b)?(og("Firebase.authWithOAuthToken",2,b),bh(this.k.O,a+"/token",{access_token:b},d,B(e,c))):(qg("Firebase.authWithOAuthToken",2,b,!1),bh(this.k.O,a+"/token",b,d,B(e,c)));return e.D};X.prototype.authWithOAuthToken=X.prototype.jg;
X.prototype.fg=function(a,b){C("Firebase.authAnonymously",0,2,arguments.length);1===arguments.length&&Fb(a)&&(b=a,a=void 0);E("Firebase.authAnonymously",1,a,!0);qg("Firebase.authAnonymously",2,b,!0);var c=new A;bh(this.k.O,"anonymous",{},b,B(c,a));return c.D};X.prototype.authAnonymously=X.prototype.fg;
X.prototype.kg=function(a,b,c){C("Firebase.authWithPassword",1,3,arguments.length);2===arguments.length&&Fb(b)&&(c=b,b=void 0);qg("Firebase.authWithPassword",1,a,!1);rg("Firebase.authWithPassword",a,"email");rg("Firebase.authWithPassword",a,"password");E("Firebase.authWithPassword",2,b,!0);qg("Firebase.authWithPassword",3,c,!0);var d=new A;bh(this.k.O,"password",a,c,B(d,b));return d.D};X.prototype.authWithPassword=X.prototype.kg;
X.prototype.re=function(a,b){C("Firebase.createUser",1,2,arguments.length);qg("Firebase.createUser",1,a,!1);rg("Firebase.createUser",a,"email");rg("Firebase.createUser",a,"password");E("Firebase.createUser",2,b,!0);var c=new A;this.k.O.re(a,B(c,b));return c.D};X.prototype.createUser=X.prototype.re;
X.prototype.Ue=function(a,b){C("Firebase.removeUser",1,2,arguments.length);qg("Firebase.removeUser",1,a,!1);rg("Firebase.removeUser",a,"email");rg("Firebase.removeUser",a,"password");E("Firebase.removeUser",2,b,!0);var c=new A;this.k.O.Ue(a,B(c,b));return c.D};X.prototype.removeUser=X.prototype.Ue;
X.prototype.oe=function(a,b){C("Firebase.changePassword",1,2,arguments.length);qg("Firebase.changePassword",1,a,!1);rg("Firebase.changePassword",a,"email");rg("Firebase.changePassword",a,"oldPassword");rg("Firebase.changePassword",a,"newPassword");E("Firebase.changePassword",2,b,!0);var c=new A;this.k.O.oe(a,B(c,b));return c.D};X.prototype.changePassword=X.prototype.oe;
X.prototype.ne=function(a,b){C("Firebase.changeEmail",1,2,arguments.length);qg("Firebase.changeEmail",1,a,!1);rg("Firebase.changeEmail",a,"oldEmail");rg("Firebase.changeEmail",a,"newEmail");rg("Firebase.changeEmail",a,"password");E("Firebase.changeEmail",2,b,!0);var c=new A;this.k.O.ne(a,B(c,b));return c.D};X.prototype.changeEmail=X.prototype.ne;
X.prototype.We=function(a,b){C("Firebase.resetPassword",1,2,arguments.length);qg("Firebase.resetPassword",1,a,!1);rg("Firebase.resetPassword",a,"email");E("Firebase.resetPassword",2,b,!0);var c=new A;this.k.O.We(a,B(c,b));return c.D};X.prototype.resetPassword=X.prototype.We;module.exports=X;
})();
