import { ElementRef, NgZone, Renderer, DynamicComponentLoader, ViewContainerRef, Type, ChangeDetectorRef, EventEmitter } from 'angular2/core';
...
export declare class Tab extends NavController {
    ...
    constructor(parentTabs: Tabs, app: IonicApp, config: Config, keyboard: Keyboard, elementRef: ElementRef, zone: NgZone, renderer: Renderer, loader: DynamicComponentLoader, _cd: ChangeDetectorRef);
    /**
     * @private
     */
