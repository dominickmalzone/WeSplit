...
var NavRouter = (function (_super) {
    ...
    function NavRouter(viewContainerRef, loader, parentRouter, nameAttr, nav) {
        if (nav.parent) {
    ...
    NavRouter = __decorate([
        ...
        __metadata('design:paramtypes', [core_1.ViewContainerRef, core_1.DynamicComponentLoader, router_1.Router, String, nav_1.Nav])
    ], NavRouter);
    return NavRouter;
