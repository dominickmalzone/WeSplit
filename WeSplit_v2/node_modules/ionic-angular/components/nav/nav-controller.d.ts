import { ViewContainerRef, DynamicComponentLoader, ResolvedReflectiveProvider, ElementRef, NgZone, Renderer, Type } from 'angular2/core';
...
export declare class NavController extends Ion {
     ...
     */
    isPortal: boolean;
    constructor(parent: any, _app: IonicApp, config: Config, _keyboard: Keyboard, elementRef: ElementRef, _zone: NgZone, _renderer: Renderer, _loader: DynamicComponentLoader);
    /**
     * @private
     */
     ...
     * @returns {Promise} Returns a promise which is resolved when the transition has completed.
     */
    push(page: Type, params?: any, opts?: NavOptions): Promise<any>;
    /**
     ...
     * @private
     */
    loadPage(view: ViewController, navbarContainerRef: ViewContainerRef, opts: NavOptions, done: Function): void;
    /**
     * @private
     */
    swipeBackStart(): void;
