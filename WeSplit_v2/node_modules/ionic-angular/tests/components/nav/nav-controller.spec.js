    ...
    describe('NavController', function () {
        describe('pop', function () {
            it('should do nothing if its the first view in the stack', function () {
                var view1 = new ionic_1.ViewController(Page1);
        ...
        describe('popToRoot', function () {
            it('should go back to root', function () {
                ...
                var view2 = new ionic_1.ViewController(Page2);
                view2.state = STATE_INACTIVE;
                var view3 = new ionic_1.ViewController(Page3);
                view3.state = STATE_INACTIVE;
                var view4 = new ionic_1.ViewController(Page4);
        ...
        describe('_remove', function () {
            ...
            it('should set to remove 2 views before active one, active stays the same', function () {
                ...
                var view5 = new ionic_1.ViewController(Page5);
        ...
        describe('_postRender', function () {
            ...
            it('should call willEnter on entering view', function () {
                var enteringView = new ionic_1.ViewController(Page1);
                var leavingView = new ionic_1.ViewController(Page2);
                var navOptions = {};
                var done = function () { };
                nav._beforeTrans = function () { }; //prevent running beforeTrans for tests
        ...
        describe('_setZIndex', function () {
            it('should set zIndex off of the previous view to the entering view is loaded and the leavingView is not loaded', function () {
                var leavingView = new ionic_1.ViewController();
                leavingView.zIndex = 100;
                leavingView._loaded = true;
                var enteringView = new ionic_1.ViewController();
        ...
        describe('_setAnimate', function () {
            it('should be unchanged when the nav is a portal', function () {
                nav._views = [new ionic_1.ViewController()];
                nav._init = false;
                nav.isPortal = true;
                var opts = {};
        ...
        describe('_insert', function () {
            ...
            it('should insert 3 pages', function () {
                ...
                nav._views = [view1];
                var insertViews = [
                    new ionic_1.ViewController(Page2),
                    new ionic_1.ViewController(Page3),
                    new ionic_1.ViewController(Page4)
                ];
        ...
        function mockNav() {
            ...
            var nav = new ionic_1.NavController(null, null, config, null, elementRef, null, null, null);
            nav._keyboard = {
                isOpen: function () {
                    return false;
                }
            ...
            nav._portal = new ionic_1.NavController(null, null, config, null, elementRef, null, null, null);
            return nav;
        }
